...
var on_center = function(){
	...
	var w_requer    = $('.after-navigation__requer').width();
	var w_cont_head = $('.after-navigation__contacts-header').outerWidth();
	var w_button    = $('.after-navigation__button').outerWidth();
	if( ( w_cont_head + w_button ) < ( ( w_after_nav - w_requer - 50 ) / 2 ) ){
		var width = ( w_after_nav - w_requer ) / 2 - w_text_logo;
