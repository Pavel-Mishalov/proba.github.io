...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var on_center=function on_center(){var w_after_nav=(0,_jquery2.default)('.after-navigation').width();var w_text_logo=(0,_jquery2.default)('.after-navigation__text-logo').outerWidth();var w_requer=(0,_jquery2.default)('.after-navigation__requer').width();var w_cont_head=(0,_jquery2.default)('.after-navigation__contacts-header').outerWidth();var w_button=(0,_jquery2.default)('.after-navigation__button').outerWidth();if(w_cont_head+w_button<(w_after_nav-w_requer-50)/2){var width=(w_after_nav-w_requer)/2-w_text_logo;(0,_jquery2.default)('.after-navigation__requer').css('margin-left',width);}else if(w_text_logo+w_requer+w_cont_head+w_button<w_after_nav){var width=(w_after_nav-w_text_logo-w_requer-w_cont_head-w_button)/2;(0,_jquery2.default)('.after-navigation__requer').css('margin-left',width);}setTimeout(function(){},10);};(0,_jquery2.default)(document).ready(on_center);(0,_jquery2.default)(window).on('resize',on_center);
