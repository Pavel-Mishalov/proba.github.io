...
>>>>>>> f9330d49bd4ca7254092407e7d976fd8e135845e
/******/ })
/************************************************************************/
/******/ ([
/* 0 */
...
"use strict";
<<<<<<< HEAD
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);var _whatInput=__webpack_require__(38);var _whatInput2=_interopRequireDefault(_whatInput);var _foundationSites=__webpack_require__(21);var _foundationSites2=_interopRequireDefault(_foundationSites);__webpack_require__(66);__webpack_require__(65);__webpack_require__(64);__webpack_require__(40);__webpack_require__(39);__webpack_require__(42);__webpack_require__(57);__webpack_require__(58);__webpack_require__(54);__webpack_require__(63);__webpack_require__(41);__webpack_require__(48);__webpack_require__(60);__webpack_require__(44);__webpack_require__(43);__webpack_require__(62);__webpack_require__(59);__webpack_require__(45);__webpack_require__(61);__webpack_require__(47);__webpack_require__(51);__webpack_require__(50);__webpack_require__(49);__webpack_require__(52);__webpack_require__(53);__webpack_require__(56);__webpack_require__(55);__webpack_require__(46);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}window.$=_jquery2.default;// If you want to pick and choose which modules to include, comment out the above and uncomment
=======
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);var _whatInput=__webpack_require__(38);var _whatInput2=_interopRequireDefault(_whatInput);var _foundationSites=__webpack_require__(21);var _foundationSites2=_interopRequireDefault(_foundationSites);__webpack_require__(65);__webpack_require__(64);__webpack_require__(40);__webpack_require__(39);__webpack_require__(42);__webpack_require__(57);__webpack_require__(58);__webpack_require__(54);__webpack_require__(63);__webpack_require__(41);__webpack_require__(48);__webpack_require__(60);__webpack_require__(44);__webpack_require__(43);__webpack_require__(62);__webpack_require__(59);__webpack_require__(45);__webpack_require__(61);__webpack_require__(47);__webpack_require__(51);__webpack_require__(50);__webpack_require__(49);__webpack_require__(52);__webpack_require__(53);__webpack_require__(56);__webpack_require__(55);__webpack_require__(46);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}window.$=_jquery2.default;// If you want to pick and choose which modules to include, comment out the above and uncomment
>>>>>>> f9330d49bd4ca7254092407e7d976fd8e135845e
// the line below
//import './lib/foundation-explicit-pieces';
(0,_jquery2.default)(document).foundation();(0,_jquery2.default)(document).ready(function(){if(_jquery2.default.browser.msie){(0,_jquery2.default)('#header, #cost-calculation, #ask-question').css('background-attachment','scroll');}});
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var open_call_requer_modal=function open_call_requer_modal(event){event.preventDefault();(0,_jquery2.default)('.modal').addClass('modal_show');(0,_jquery2.default)('.modal').data('open','call-requer');(0,_jquery2.default)('.modal__call-requer').addClass('modal__call-requer_show').focus();};var close_call_requer_modal=function close_call_requer_modal(event){event.preventDefault();(0,_jquery2.default)('.modal').removeClass('modal_show');var modal=(0,_jquery2.default)('.modal').data('open');(0,_jquery2.default)('.modal__'+modal).removeClass('modal__'+modal+'_show');};var onfocus_call_requer_modal=function onfocus_call_requer_modal(event){if((0,_jquery2.default)(event.target).hasClass('modal_show')){var modal=(0,_jquery2.default)('.modal').data('open');var container=(0,_jquery2.default)('.modal__'+modal);(0,_jquery2.default)('.modal').removeClass('modal_show');(0,_jquery2.default)('.modal__'+modal).removeClass('modal__'+modal+'_show');}};(0,_jquery2.default)('.after-navigation__button').on('click',open_call_requer_modal);(0,_jquery2.default)('.step-work__content a:not([href^="tel"])').on('click',open_call_requer_modal);(0,_jquery2.default)('.call-requer__close-button').on('click',close_call_requer_modal);(0,_jquery2.default)('.modal').bind('click',onfocus_call_requer_modal);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(0,_jquery2.default)('.input__file-input[type="file"]').bind('change',function(){var abs_path=(0,_jquery2.default)(this).val().split('\\');(0,_jquery2.default)(this).parent().find('.input__file-input:not([type="file"])').text(abs_path[abs_path.length-1]);});(0,_jquery2.default)('.input__file-input:not([type="file"])').click(function(){(0,_jquery2.default)(this).parent().find('.input__file-input[type="file"]').click();});
<<<<<<< HEAD
=======
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(0,_jquery2.default)(document).ready(function(){if((0,_jquery2.default)('#yandex-map-address').length>0){ymaps.ready(yandex_init);}(0,_jquery2.default)('#yandex-map-address').css('pointer-events','none');(0,_jquery2.default)('#map-address').click(function(){(0,_jquery2.default)('#yandex-map-address').css('pointer-events','auto');});(0,_jquery2.default)('#map-address').mouseleave(function(){(0,_jquery2.default)('#yandex-map-address').css('pointer-events','none');});});var yandex_init=function yandex_init(){_jquery2.default.ajax({method:"POST",url:ajax.url,data:{"action":'miracle_yandex_map_init',"nonce":ajax.nonce},success:yandex_success,error:yandex_error});};var yandex_success=function yandex_success(data){var points=_jquery2.default.parseJSON(data);var cx=points.center.x;var cy=points.center.y;var px=points.point.x;var py=points.point.y;var phone=points.phone;var timeWork=points.timeWork;var bt=points.balloon.title;var bst=points.balloon.subtitle;var hint=points.hint;var myMap=new ymaps.Map('yandex-map-address',{center:[cx,cy],zoom:13},{searchControlProvider:'yandex#search'}),myPlacemark=new ymaps.Placemark([px,py],{hintContent:hint,balloonContent:'<div class="wrap-form"><div class="wrap-form__form-title form-title"><h3 class="form-title__title">'+bt+'</h3><p class="form-title__subtitle" style="text-align: left;">'+bst+'</p></div><div class="wrap-form__form form"><div class="contacts-header" style="text-align:left"><a href="javascript:void(0)" class="contacts-header__phone">'+phone+'</a><p class="contacts-header__schedule">'+timeWork+'</p></div></div></div>'},{iconLayout:'default#image',//iconImageSize: [30, 30],
//iconImageHref: 'https://avatanplus.com/files/resources/mid/57b4a96fdc61c15699b5dd1f.png',
iconImageOffset:[0,0]});myMap.geoObjects.add(myPlacemark);};var yandex_error=function yandex_error(){console.log('Sorry. The request has not passed, maybe you violated the rules of using the site');};
>>>>>>> f9330d49bd4ca7254092407e7d976fd8e135845e
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(0,_jquery2.default)(document).ready(function(){(0,_jquery2.default)('.mir-slider .slide .slide__owl-carousel-slider').each(function(index,item){(0,_jquery2.default)(item).owlCarousel({loop:true,margin:10,stagePadding:0,nav:true,dots:false,lazyLoad:true,navText:['<i class="miracle-icon-left-chevron"></i>','<i class="miracle-icon-right-chevron"></i>'],responsive:{500:{items:1},700:{items:3},900:{items:4},1000:{items:5}}});if((0,_jquery2.default)('body').width()>900){var h=(0,_jquery2.default)(item).width()/5-10;(0,_jquery2.default)(item).find('.item').height(h);}else if((0,_jquery2.default)('body').width()<900&&(0,_jquery2.default)('body').width()>700){var h=(0,_jquery2.default)(item).width()/4-10;(0,_jquery2.default)(item).find('.item').height(h);}else if((0,_jquery2.default)('body').width()<700&&(0,_jquery2.default)('body').width()>500){var h=(0,_jquery2.default)(item).width()/3-10;(0,_jquery2.default)(item).find('.item').height(h);}else if((0,_jquery2.default)('body').width()<500){var h=(0,_jquery2.default)(item).width()/1-10;(0,_jquery2.default)(item).find('.item').height(h);}if(_jquery2.default.browser.msie){(0,_jquery2.default)(item).find('.item').each(function(i,elem){var image=(0,_jquery2.default)(elem).find('img').attr('src');var title=(0,_jquery2.default)(elem).find('img').attr('title');if(image!=undefined){(0,_jquery2.default)(elem).css({'background-image':'url('+image+')','background-repeat':'no-repeat','background-size':'cover','background-position':'center center'}).attr('title',title);}else{var image=(0,_jquery2.default)(elem).find('img').attr('data-src');(0,_jquery2.default)(elem).css({'background-image':'url('+image+')','background-repeat':'no-repeat','background-size':'cover','background-position':'center center'}).attr('title',title);}(0,_jquery2.default)(elem).find('img').remove();});}});});var height_owl_item=function height_owl_item(){(0,_jquery2.default)('.mir-slider .slide .slide__owl-carousel-slider').each(function(index,item){var h=(0,_jquery2.default)(item).width()/5-10;(0,_jquery2.default)(item).find('.item').height(h);});};(0,_jquery2.default)(window).on('resize',height_owl_item);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(0,_jquery2.default)(document).ready(function(){(0,_jquery2.default)('.mir-slider .slide .feedback-carousel').each(function(index,item){(0,_jquery2.default)(item).owlCarousel({items:1,merge:false,loop:false,margin:10,video:true,lazyLoad:true,dots:false,nav:false});var h=(0,_jquery2.default)(item).parent().parent().find('.slide__content').height();(0,_jquery2.default)(item).find('.item-video').height(h);});});var add_height_item_video=function add_height_item_video(){(0,_jquery2.default)('.mir-slider .slide .feedback-carousel').each(function(index,item){var h=(0,_jquery2.default)(item).parent().parent().find('.slide__content').height();(0,_jquery2.default)(item).find('.item-video').height(h);});};(0,_jquery2.default)(window).on('resize',add_height_item_video);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var init_mir_slider=function init_mir_slider(){if((0,_jquery2.default)('.mir-slider').length>0){(0,_jquery2.default)('.mir-slider').find('.slide').each(function(index,element){var title=(0,_jquery2.default)(element).find('.slide__title').text();(0,_jquery2.default)(element).data('title',title);(0,_jquery2.default)(element).find('.slide__title').remove();if(index==0){(0,_jquery2.default)(element).css({'position':'relative','top':'0','transition':'transform 0.6s ease-in-out 0s'});var title=(0,_jquery2.default)(element).data('title');(0,_jquery2.default)('.slider-nav__title').text(title);}else{var t='translateX('+100*index+'% )';(0,_jquery2.default)(element).css({'position':'absolute','top':'7rem','transform':t});setTimeout(function(){(0,_jquery2.default)(element).css({'transition':'transform 0.6s ease-in-out 0s'});},600);}});(0,_jquery2.default)('.mir-slider').data({'position':1,'slides':(0,_jquery2.default)('.mir-slider').find('.slide').length});}};var next_slide=function next_slide(){var bollean=(0,_jquery2.default)('.slider-nav__button-next').attr('disabled');if(bollean!='disabled'){var p=(0,_jquery2.default)('.mir-slider').data('position');var slides=(0,_jquery2.default)('.mir-slider').data('slides');(0,_jquery2.default)('.mir-slider').find('.slide').each(function(index,element){if(index==p){(0,_jquery2.default)(element).css({'position':'relative','top':0,'transform':'translateX(0%)'});if(p==slides-1){(0,_jquery2.default)('.slider-nav__button-next').attr('disabled','disabled');}else if(p==1){(0,_jquery2.default)('.slider-nav__button-prev').removeAttr('disabled');}var title=(0,_jquery2.default)(element).data('title');(0,_jquery2.default)('.slider-nav__title').fadeOut(300,function(){(0,_jquery2.default)('.slider-nav__title').text(title);(0,_jquery2.default)('.slider-nav__title').fadeIn(300);});}else{var t='translateX('+100*(index-p)+'% )';(0,_jquery2.default)(element).css({'position':'absolute','top':'7rem','transform':t});}});(0,_jquery2.default)('.mir-slider').data({'position':p+1,'slides':(0,_jquery2.default)('.mir-slider').find('.slide').length});}};var prev_slide=function prev_slide(){var bollean=(0,_jquery2.default)('.slider-nav__button-prev').attr('disabled');if(bollean!='disabled'){var p=(0,_jquery2.default)('.mir-slider').data('position');var slides=(0,_jquery2.default)('.mir-slider').data('slides');(0,_jquery2.default)('.mir-slider').find('.slide').each(function(index,element){if(index==p-2){(0,_jquery2.default)(element).css({'position':'relative','top':0,'transform':'translateX(0%)'});if(p==2){(0,_jquery2.default)('.slider-nav__button-prev').attr('disabled','disabled');}else if(p==slides){(0,_jquery2.default)('.slider-nav__button-next').removeAttr('disabled');}var title=(0,_jquery2.default)(element).data('title');(0,_jquery2.default)('.slider-nav__title').fadeOut(300,function(){(0,_jquery2.default)('.slider-nav__title').text(title);(0,_jquery2.default)('.slider-nav__title').fadeIn(300);});}else{var t='translateX('+100*(2+index-p)+'% )';(0,_jquery2.default)(element).css({'position':'absolute','top':'7rem','transform':t});}});(0,_jquery2.default)('.mir-slider').data({'position':p-1,'slides':(0,_jquery2.default)('.mir-slider').find('.slide').length});}};(0,_jquery2.default)(document).ready(init_mir_slider);(0,_jquery2.default)('.slider-nav__button-next').bind('click',next_slide);(0,_jquery2.default)('.slider-nav__button-prev').bind('click',prev_slide);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var init_tab=function init_tab(){if((0,_jquery2.default)('.mir-tabs').length>0){(0,_jquery2.default)('.mir-tabs').find('.mir-tab').each(function(index,item){(0,_jquery2.default)(item).data('active',false);var h=(0,_jquery2.default)(item).find('.mir-tab__question').outerHeight();var ih=(0,_jquery2.default)(item).find('.mir-tab__icon').height();var iw=(0,_jquery2.default)(item).find('.mir-tab__icon').width();var pv=(h-ih-2)/2;var ph=(h-iw-1)/2;(0,_jquery2.default)(item).find('.mir-tab__icon').css('padding',pv+'px '+ph+'px');(0,_jquery2.default)(item).find('.mir-tab__question').css('width','calc( 100% - '+h+'px )');});}};(0,_jquery2.default)(document).ready(init_tab);var click_tab=function click_tab(){var tab=this;(0,_jquery2.default)(this).find('.mir-tab__answer').slideToggle(300);(0,_jquery2.default)(this).find('.mir-tab__icon').find('i').toggleClass('miracle-icon-chevron-down miracle-icon-up-chevron');if((0,_jquery2.default)(this).data('active')){(0,_jquery2.default)(this).data('active',false);}else{(0,_jquery2.default)(this).data('active',true);}};(0,_jquery2.default)('.mir-tab').on('click',click_tab);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var toggle_post=function toggle_post(){(0,_jquery2.default)(this).toggleClass('nav-tab__link_active');(0,_jquery2.default)(this).find('.nav-tab__icon').toggleClass('miracle-icon-up-chevron miracle-icon-chevron-down');(0,_jquery2.default)(this).parent().find('.nav-tab__posts').slideToggle(400,function(){(0,_jquery2.default)(this).parent().find('.nav-tab__posts').toggleClass('nav-tab__posts_active').removeAttr('style');});};(0,_jquery2.default)('.nav-tab__link').on('click',toggle_post);
...
=======
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var add_post_blog_page=function add_post_blog_page(){var offset=(0,_jquery2.default)('.archive-post .post-card').length;var options={"offset":offset,"action":'miracle_add_new_post_cart_in_blog',"nonce":ajax.nonce};if((0,_jquery2.default)('.page-content__button').attr('data-cat')!=undefined){options.category=(0,_jquery2.default)('.page-content__button').attr('data-cat');}if((0,_jquery2.default)('.page-content__button').attr('data-tag')!=undefined){options.tag=(0,_jquery2.default)('.page-content__button').attr('data-tag');}if((0,_jquery2.default)('.page-content__button').attr('data-search')!=undefined){options.search=(0,_jquery2.default)('.page-content__title').text();}_jquery2.default.ajax({method:"POST",url:ajax.url,data:options,success:add_post_blog_page_success,beforeSend:add_post_blog_page_before,error:add_post_blog_page_error});};(0,_jquery2.default)('.page-content__button').on('click',add_post_blog_page);var add_post_blog_page_success=function add_post_blog_page_success(data){var html=(0,_jquery2.default)(data);(0,_jquery2.default)('.archive-post').append(html);if(_jquery2.default.browser.msie){if((0,_jquery2.default)('body').width()<1100&&(0,_jquery2.default)('body').width()>900||(0,_jquery2.default)('body').width()<700){(0,_jquery2.default)('.archive-post').find('.archive-post__post-card').each(function(index,item){var row=(index-index%2)/2+1;(0,_jquery2.default)(item).attr('style','-ms-grid-row: '+row);});}else if((0,_jquery2.default)('body').width()<400){(0,_jquery2.default)('.archive-post').find('.archive-post__post-card').each(function(index,item){(0,_jquery2.default)(item).attr('style','-ms-grid-row: '+index);});}else{(0,_jquery2.default)('.archive-post').find('.archive-post__post-card').each(function(index,item){var row=(index-index%3)/3+1;(0,_jquery2.default)(item).attr('style','-ms-grid-row: '+row);});}}(0,_jquery2.default)('.archive-post').productCardImageResize();if(html.length!=3){(0,_jquery2.default)('.page-content__button').removeAttr('disabled');(0,_jquery2.default)('.page-content__button').fadeOut();}else{(0,_jquery2.default)('.page-content__button').removeAttr('disabled');}(0,_jquery2.default)('.archive-post').css('filter','grayscale(0%)');setTimeout(function(){(0,_jquery2.default)('.archive-post').removeAttr('style');},400);};var add_post_blog_page_before=function add_post_blog_page_before(){(0,_jquery2.default)('.page-content__button').attr('disabled','disabled');(0,_jquery2.default)('.archive-post').css({'transition':'filter 0.3s ease-out 0s','filter':'grayscale(100%)'});};var add_post_blog_page_error=function add_post_blog_page_error(){console.log('Sorry. The request has not passed, maybe you violated the rules of using the site');};var on_ready=function on_ready(){if((0,_jquery2.default)('.page-content__button').length>0&&(0,_jquery2.default)('.page-content__button').attr('data-page')!='post'){var posts=(0,_jquery2.default)('.archive-post .post-card').length;if(posts<=5){(0,_jquery2.default)('.page-content__button').hide();if((0,_jquery2.default)('.page-content__button').attr('data-search')!=undefined&&posts==0){var s=(0,_jquery2.default)('.page-content__title').text();(0,_jquery2.default)('.page-content__title').text('Просим прошения по запросу: "'+s+'" ничего не найдено.');}}}};(0,_jquery2.default)(document).ready(on_ready);
>>>>>>> f9330d49bd4ca7254092407e7d976fd8e135845e
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};};(function(window,document,undefined){_jquery2.default.fn.productCardImageResize=function(){var card=this.find('.post-card');var width=card.first().width();var height=width/1.4344;this.find('.post-card__image').each(function(index,element){(0,_jquery2.default)(element).css('height',height);if(_jquery2.default.browser.msie&&(0,_jquery2.default)(element).find('img').attr('src')!=undefined){var src=(0,_jquery2.default)(element).find('img').attr('src');(0,_jquery2.default)(element).find('img').remove();(0,_jquery2.default)(element).css('background-image','url('+src+')');}});var title_height=0;this.find('.post-card__title').css('height','auto');this.find('.archive-post__post-card').each(function(index,item){var h=(0,_jquery2.default)(item).find('.post-card__title').height();title_height=h>title_height?h:title_height;});this.find('.post-card__title').height(title_height);var description_height=0;this.find('.post-card__description').height('height','auto');this.find('.archive-post__post-card').each(function(index,item){var h=(0,_jquery2.default)(item).find('.post-card__description').height();description_height=h>description_height?h:description_height;});this.find('.post-card__description').height(description_height);return this;};})(window,document);(0,_jquery2.default)(document).ready(function(){(0,_jquery2.default)('.archive-post').productCardImageResize();});(0,_jquery2.default)(window).on('resize',function(){(0,_jquery2.default)('.archive-post').productCardImageResize();});
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var resize_image=function resize_image(){(0,_jquery2.default)('.product-card__image').each(function(index,element){var width=(0,_jquery2.default)(element).width();var height=width/1.45;(0,_jquery2.default)(element).height(height);if(_jquery2.default.browser.msie){var image=(0,_jquery2.default)(element).find('img').attr('src');var title=(0,_jquery2.default)(element).find('img').attr('title');if(image!=undefined){(0,_jquery2.default)(element).css('background-image','url('+image+')').attr('title',title);}else{$image=(0,_jquery2.default)(element).find('img').attr('data-src');if(image!=undefined){(0,_jquery2.default)(element).css('background-image','url('+image+')').attr('title',title);}}(0,_jquery2.default)(element).find('img').remove();}});};(0,_jquery2.default)(document).ready(resize_image);(0,_jquery2.default)(window).on('resize',resize_image);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var open_product_modal=function open_product_modal(event){event.preventDefault();(0,_jquery2.default)('.modal').addClass('modal_show');(0,_jquery2.default)('.modal').data('open','product-modal');var product_card=(0,_jquery2.default)(this).parent().attr('data-category');var position=(0,_jquery2.default)(this).attr('data-position');(0,_jquery2.default)('.modal__product-modal[data-category="'+product_card+'"] .menu__link').removeClass('menu__link_active');(0,_jquery2.default)('.modal__product-modal[data-category="'+product_card+'"] .menu__link:eq('+position+')').addClass('menu__link_active');(0,_jquery2.default)('.modal__product-modal[data-category="'+product_card+'"] .product-modal__slide').hide();(0,_jquery2.default)('.modal__product-modal[data-category="'+product_card+'"] .product-modal__slide:eq('+position+')').show();(0,_jquery2.default)('.modal').data('category',product_card);(0,_jquery2.default)('.modal').data('product',position);(0,_jquery2.default)('.modal__product-modal[data-category="'+product_card+'"]').addClass('modal__product-modal_show').focus();};var click_product=function click_product(event){event.preventDefault();if(!(0,_jquery2.default)(this).hasClass('menu__link_active')){var next=(0,_jquery2.default)(this).attr('data-id');var cat=(0,_jquery2.default)('.modal').data('category');var position=(0,_jquery2.default)('.modal').data('product');(0,_jquery2.default)('.modal__product-modal[data-category="'+cat+'"] .menu__link').removeClass('menu__link_active');(0,_jquery2.default)(this).addClass('menu__link_active');(0,_jquery2.default)('.modal__product-modal[data-category="'+cat+'"] .product-modal__slide:eq('+position+')').fadeOut(400,function(){(0,_jquery2.default)('.modal__product-modal[data-category="'+cat+'"] .product-modal__slide:eq('+next+')').fadeIn(400);});(0,_jquery2.default)('.modal').data('product',next);}};var click_other_product=function click_other_product(){var cat=(0,_jquery2.default)('.modal').data('category');var next=(0,_jquery2.default)(this).attr('data-category');var position=0;(0,_jquery2.default)('.modal__product-modal[data-category="'+cat+'"]').fadeOut(400,function(){(0,_jquery2.default)('.modal__product-modal[data-category="'+cat+'"]').removeClass('modal__product-modal_show');(0,_jquery2.default)('.modal__product-modal[data-category="'+cat+'"]').removeAttr('style');(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"] .menu__link').removeClass('menu__link_active');(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"] .menu__link:eq('+position+')').addClass('menu__link_active');(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"] .product-modal__slide').hide();(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"] .product-modal__slide:eq('+position+')').show();(0,_jquery2.default)('.modal').data('category',next);(0,_jquery2.default)('.modal').data('product',position);(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"]').fadeIn(400,function(){(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"]').addClass('modal__product-modal_show').focus();(0,_jquery2.default)('.modal__product-modal[data-category="'+next+'"]').removeAttr('style');});});};(0,_jquery2.default)('.product-card__direction').on('click',open_product_modal);(0,_jquery2.default)('.modal__product-modal .menu__link').on('click',click_product);(0,_jquery2.default)('.modal__product-modal .other-product__link button').on('click',click_other_product);
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var add_work_click=function add_work_click(){var cat_obj=(0,_jquery2.default)('.work__work-categories .work-categories__item_active');var category=cat_obj.text()=='Все'?'all':cat_obj.text();var offset=(0,_jquery2.default)('.works .work-card').length;_jquery2.default.ajax({method:"POST",url:ajax.url,data:{"cat":category,"offset":offset,"action":'miracle_add_new_work',"page":ajax.i,"nonce":ajax.nonce},success:add_work_success,beforeSend:add_work_before,error:add_work_error});};(0,_jquery2.default)('.work__button').on('click',add_work_click);var add_work_success=function add_work_success(data){var html=(0,_jquery2.default)(data);(0,_jquery2.default)('.works').append(html);(0,_jquery2.default)('.works').workResize();if(html.length!=3){(0,_jquery2.default)('.work__button').removeAttr('disabled');(0,_jquery2.default)('.work__button').fadeOut();}else{(0,_jquery2.default)('.work__button').removeAttr('disabled');}console.log(html.length);};var add_work_before=function add_work_before(){(0,_jquery2.default)('.work__button').attr('disabled','disabled');};var add_work_error=function add_work_error(){console.log('Sorry. The request has not passed, maybe you violated the rules of using the site');};
...
"use strict";
var _jquery=__webpack_require__(0);var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}// ==================================================
// fancyBox v3.1.20
//
...
// =========================================
if(!_jquery2.default){return;}// Check if fancyBox is already initialized
// ========================================
if(_jquery2.default.fn.fancybox){_jquery2.default.error('fancyBox already initialized');return;}// Private default settings
// ========================
var defaults={// Enable infinite gallery navigation
loop:false,// Space around image, ignored if zoomed-in or viewport smaller than 800px
...
infobar:false,// Should display toolbar (buttons at the top)
toolbar:true,// What buttons should appear in the top right corner.
// Buttons will be created using templates from `btnTpl` option
// and they will be placed into toolbar (class="fancybox-toolbar"` element)
buttons:['slideShow','fullScreen','thumbs','close'],// Detect "idle" time in seconds
idleTime:4,// Should display buttons at top right corner of the content
...
attr:{scrolling:'auto'}},// Open/close animation type
// Possible values:
//   false            - disable
...
baseTpl:'<div class="fancybox-container" role="dialog" tabindex="-1">'+'<div class="fancybox-bg"></div>'+'<div class="fancybox-inner">'+'<div class="fancybox-infobar">'+'<button data-fancybox-prev title="{{PREV}}" class="fancybox-button fancybox-button--left"></button>'+'<div class="fancybox-infobar__body">'+'<span data-fancybox-index></span>&nbsp;/&nbsp;<span data-fancybox-count></span>'+'</div>'+'<button data-fancybox-next title="{{NEXT}}" class="fancybox-button fancybox-button--right"></button>'+'</div>'+'<div class="fancybox-toolbar">'+'{{BUTTONS}}'+'</div>'+'<div class="fancybox-navigation">'+'<button data-fancybox-prev title="{{PREV}}" class="fancybox-arrow fancybox-arrow--left" />'+'<button data-fancybox-next title="{{NEXT}}" class="fancybox-arrow fancybox-arrow--right" />'+'</div>'+'<div class="fancybox-stage"></div>'+'<div class="fancybox-caption-wrap">'+'<div class="fancybox-caption"></div>'+'</div>'+'</div>'+'</div>',// Loading indicator template
...
smallBtn:'<button data-fancybox-close class="fancybox-close-small" title="{{CLOSE}}"></button>'},// Container is injected into this element
...
// =======================
fullScreen:{autoStart:false},touch:{vertical:true,// Allow to drag content vertically
...
/*
        ...
        */onInit:_jquery2.default.noop,// When instance has been initialized
beforeLoad:_jquery2.default.noop,// Before the content of a slide is being loaded
afterLoad:_jquery2.default.noop,// When the content of a slide is done loading
beforeShow:_jquery2.default.noop,// Before open animation starts
afterShow:_jquery2.default.noop,// When content is done loading and animating
beforeClose:_jquery2.default.noop,// Before the instance attempts to close. Return false to cancel the close.
afterClose:_jquery2.default.noop,// After instance has been closed
onActivate:_jquery2.default.noop,// When instance is brought to front
onDeactivate:_jquery2.default.noop,// When other instance has been activated
// Interaction
// ===========
...
// =============================================
mobile:{clickContent:function clickContent(current,event){return current.type==='image'?'toggleControls':false;},clickSlide:function clickSlide(current,event){return current.type==='image'?'toggleControls':"close";},dblclickContent:function dblclickContent(current,event){return current.type==='image'?'zoom':false;},dblclickSlide:function dblclickSlide(current,event){return current.type==='image'?'zoom':false;}},// Internationalization
// ============
lang:'en',i18n:{'en':{CLOSE:'Close',NEXT:'Next',PREV:'Previous',ERROR:'The requested content cannot be loaded. <br/> Please try again later.',PLAY_START:'Start slideshow',PLAY_STOP:'Pause slideshow',FULL_SCREEN:'Full screen',THUMBS:'Thumbnails'},'de':{CLOSE:'Schliessen',NEXT:'Weiter',PREV:'Zurück',ERROR:'Die angeforderten Daten konnten nicht geladen werden. <br/> Bitte versuchen Sie es später nochmal.',PLAY_START:'Diaschau starten',PLAY_STOP:'Diaschau beenden',FULL_SCREEN:'Vollbild',THUMBS:'Vorschaubilder'}}};// Few useful variables and methods
// ================================
var $W=(0,_jquery2.default)(window);var $D=(0,_jquery2.default)(document);var called=0;// Check if an object is a jQuery object and not a native JavaScript object
// ========================================================================
var isQuery=function isQuery(obj){return obj&&obj.hasOwnProperty&&obj instanceof _jquery2.default;};// Handle multiple browsers for "requestAnimationFrame" and "cancelAnimationFrame"
// ===============================================================================
...
// =======================================================
var transitionEnd=function(){var t,el=document.createElement("fakeelement");var transitions={"transition":"transitionend","OTransition":"oTransitionEnd","MozTransition":"transitionend","WebkitTransition":"webkitTransitionEnd"};for(t in transitions){if(el.style[t]!==undefined){return transitions[t];}}}();// Force redraw on an element.
// This helps in cases where the browser doesn't redraw an updated element properly.
// =================================================================================
var forceRedraw=function forceRedraw($el){return $el&&$el.length&&$el[0].offsetHeight;};// Class definition
// ================
var FancyBox=function FancyBox(content,opts,index){var self=this;self.opts=_jquery2.default.extend(true,{index:index},defaults,opts||{});// Exclude buttons option from deep merging
if(opts&&_jquery2.default.isArray(opts.buttons)){self.opts.buttons=opts.buttons;}self.id=self.opts.id||++called;self.group=[];self.currIndex=parseInt(self.opts.index,10)||0;self.prevIndex=null;self.prevPos=null;self.currPos=0;self.firstRun=null;// Create group elements from original item collection
self.createGroup(content);if(!self.group.length){return;}// Save last active element and current scroll position
self.$lastFocus=(0,_jquery2.default)(document.activeElement).blur();// Collection of gallery objects
self.slides={};self.init(content);};_jquery2.default.extend(FancyBox.prototype,{// Create DOM structure
// ====================
init:function init(){var self=this;var testWidth,$container,buttonStr;var firstItemOpts=self.group[self.currIndex].opts;self.scrollTop=$D.scrollTop();self.scrollLeft=$D.scrollLeft();// Hide scrollbars
// ===============
if(!_jquery2.default.fancybox.getInstance()&&!_jquery2.default.fancybox.isMobile&&(0,_jquery2.default)('body').css('overflow')!=='hidden'){testWidth=(0,_jquery2.default)('body').width();(0,_jquery2.default)('html').addClass('fancybox-enabled');// Compare body width after applying "overflow: hidden"
testWidth=(0,_jquery2.default)('body').width()-testWidth;// If width has changed - compensate missing scrollbars by adding right margin
if(testWidth>1){(0,_jquery2.default)('head').append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar, .fancybox-enabled body { margin-right: '+testWidth+'px; }</style>');}}// Build html markup and set references
// ====================================
// Build html code for buttons and insert into main template
buttonStr='';_jquery2.default.each(firstItemOpts.buttons,function(index,value){buttonStr+=firstItemOpts.btnTpl[value]||'';});// Create markup from base template, it will be initially hidden to
// avoid unnecessary work like painting while initializing is not complete
$container=(0,_jquery2.default)(self.translate(self,firstItemOpts.baseTpl.replace('\{\{BUTTONS\}\}',buttonStr))).addClass('fancybox-is-hidden').attr('id','fancybox-container-'+self.id).addClass(firstItemOpts.baseClass).data('FancyBox',self).prependTo(firstItemOpts.parentEl);// Create object holding references to jQuery wrapped nodes
self.$refs={container:$container};['bg','inner','infobar','toolbar','stage','caption'].forEach(function(item){self.$refs[item]=$container.find('.fancybox-'+item);});// Check for redundant elements
if(!firstItemOpts.arrows||self.group.length<2){$container.find('.fancybox-navigation').remove();}if(!firstItemOpts.infobar){self.$refs.infobar.remove();}if(!firstItemOpts.toolbar){self.$refs.toolbar.remove();}self.trigger('onInit');// Bring to front and enable events
...
// ===============================================
createGroup:function createGroup(content){var self=this;var items=_jquery2.default.makeArray(content);_jquery2.default.each(items,function(i,item){var obj={},opts={},data=[],$item,type,src,srcParts;// Step 1 - Make sure we have an object
// ====================================
if(_jquery2.default.isPlainObject(item)){// We probably have manual usage here, something like
// $.fancybox.open( [ { src : "image.jpg", type : "image" } ] )
obj=item;opts=item.opts||item;}else if(_jquery2.default.type(item)==='object'&&(0,_jquery2.default)(item).length){// Here we propbably have jQuery collection returned by some selector
$item=(0,_jquery2.default)(item);data=$item.data();opts='options'in data?data.options:{};opts=_jquery2.default.type(opts)==='object'?opts:{};obj.src='src'in data?data.src:opts.src||$item.attr('href');['width','height','thumb','type','filter'].forEach(function(item){if(item in data){opts[item]=data[item];}});if('srcset'in data){opts.image={srcset:data.srcset};}opts.$orig=$item;if(!obj.type&&!obj.src){obj.type='inline';obj.src=item;}}else{// Assume we have a simple html code, for example:
// $.fancybox.open( '<div><h1>Hi!</h1></div>' );
obj={type:'html',src:item+''};}// Each gallery object has full collection of options
obj.opts=_jquery2.default.extend(true,{},self.opts,opts);if(_jquery2.default.fancybox.isMobile){obj.opts=_jquery2.default.extend(true,{},obj.opts,obj.opts.mobile);}// Step 2 - Make sure we have content type, if not - try to guess
// ==============================================================
type=obj.type||obj.opts.type;src=obj.src||'';if(!type&&src){if(src.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i)){type='image';}else if(src.match(/\.(pdf)((\?|#).*)?$/i)){type='pdf';}else if(src.charAt(0)==='#'){type='inline';}}obj.type=type;// Step 3 - Some adjustments
// =========================
...
if(_jquery2.default.type(obj.opts.caption)==='function'){obj.opts.caption=obj.opts.caption.apply(item,[self,obj]);}else if('caption'in data){obj.opts.caption=data.caption;}// Make sure we have caption as a string
...
if(type==='ajax'){srcParts=src.split(/\s+/,2);if(srcParts.length>1){obj.src=srcParts.shift();obj.opts.filter=srcParts.shift();}}if(obj.opts.smallBtn=='auto'){if(_jquery2.default.inArray(type,['html','inline','ajax'])>-1){obj.opts.toolbar=false;obj.opts.smallBtn=true;}else{obj.opts.smallBtn=false;}}// If the type is "pdf", then simply load file into iframe
if(type==='pdf'){obj.type='iframe';obj.opts.iframe.preload=false;}// Hide all buttons and disable interactivity for modal items
if(obj.opts.modal){obj.opts=_jquery2.default.extend(true,obj.opts,{// Remove buttons
...
$D.on('focusin.fb',function(e){var instance=_jquery2.default.fancybox?_jquery2.default.fancybox.getInstance():null;if(instance.isClosing||!instance.current||!instance.current.opts.trapFocus||(0,_jquery2.default)(e.target).hasClass('fancybox-container')||(0,_jquery2.default)(e.target).is(document)){return;}if(instance&&(0,_jquery2.default)(e.target).css('position')!=='fixed'&&!instance.$refs.container.has(e.target).length){e.stopPropagation();instance.focus();// Sometimes page gets scrolled, set it back
$W.scrollTop(self.scrollTop).scrollLeft(self.scrollLeft);}});// Enable keyboard navigation
$D.on('keydown.fb',function(e){var current=self.current,keycode=e.keyCode||e.which;if(!current||!current.opts.keyboard){return;}if((0,_jquery2.default)(e.target).is('input')||(0,_jquery2.default)(e.target).is('textarea')){return;}// Backspace and Esc keys
...
current=self.createSlide(pos);if(groupLen>1){if(loop||current.index>0){self.createSlide(pos-1);}if(loop||current.index<groupLen-1){self.createSlide(pos+1);}}self.current=current;self.currIndex=current.index;self.currPos=current.pos;self.trigger('beforeShow',firstRun);self.updateControls();currentPos=_jquery2.default.fancybox.getTranslate(current.$slide);current.isMoved=(currentPos.left!==0||currentPos.top!==0)&&!current.$slide.hasClass('fancybox-animated');current.forcedDuration=undefined;if(_jquery2.default.isNumeric(duration)){current.forcedDuration=duration;}else{duration=current.opts[firstRun?'animationDuration':'transitionDuration'];}duration=parseInt(duration,10);// Fresh start - reveal container, current slide and start loading content
...
_jquery2.default.each(self.slides,function(index,slide){_jquery2.default.fancybox.stop(slide.$slide);});// Make current that slide is visible even if content is still loading
...
// =====================
transitionProps='fancybox-slide--'+(previous.pos>current.pos?'next':'previous');previous.$slide.removeClass('fancybox-slide--complete fancybox-slide--current fancybox-slide--next fancybox-slide--previous');previous.isComplete=false;if(!duration||!current.isMoved&&!current.opts.transitionEffect){return;}if(current.isMoved){previous.$slide.addClass(transitionProps);}else{transitionProps='fancybox-animated '+transitionProps+' fancybox-fx-'+current.opts.transitionEffect;_jquery2.default.fancybox.animate(previous.$slide,transitionProps,duration,function(){previous.$slide.removeClass(transitionProps).removeAttr('style');});}},// Create new "slide" element
// These are gallery items  that are actually added to DOM
// =======================================================
createSlide:function createSlide(pos){var self=this;var $slide;var index;index=pos%self.group.length;index=index<0?self.group.length+index:index;if(!self.slides[pos]&&self.group[index]){$slide=(0,_jquery2.default)('<div class="fancybox-slide"></div>').appendTo(self.$refs.stage);self.slides[pos]=_jquery2.default.extend(true,{},self.group[index],{pos:pos,$slide:$slide,isLoaded:false});self.updateSlide(self.slides[pos]);}return self.slides[pos];},// Scale image to the actual size of the image
// ===========================================
scaleToActual:function scaleToActual(x,y,duration){var self=this;var current=self.current;var $what=current.$content;var imgPos,posX,posY,scaleX,scaleY;var canvasWidth=parseInt(current.$slide.width(),10);var canvasHeight=parseInt(current.$slide.height(),10);var newImgWidth=current.width;var newImgHeight=current.height;if(!(current.type=='image'&&!current.hasError)||!$what||self.isAnimating){return;}_jquery2.default.fancybox.stop($what);self.isAnimating=true;x=x===undefined?canvasWidth*0.5:x;y=y===undefined?canvasHeight*0.5:y;imgPos=_jquery2.default.fancybox.getTranslate($what);scaleX=newImgWidth/imgPos.width;scaleY=newImgHeight/imgPos.height;// Get center position for original image
...
if(newImgWidth>canvasWidth){posX=imgPos.left*scaleX-(x*scaleX-x);if(posX>0){posX=0;}if(posX<canvasWidth-newImgWidth){posX=canvasWidth-newImgWidth;}}if(newImgHeight>canvasHeight){posY=imgPos.top*scaleY-(y*scaleY-y);if(posY>0){posY=0;}if(posY<canvasHeight-newImgHeight){posY=canvasHeight-newImgHeight;}}self.updateCursor(newImgWidth,newImgHeight);_jquery2.default.fancybox.animate($what,{top:posY,left:posX,scaleX:scaleX,scaleY:scaleY},duration||330,function(){self.isAnimating=false;});// Stop slideshow
if(self.SlideShow&&self.SlideShow.isActive){self.SlideShow.stop();}},// Scale image to fit inside parent element
// ========================================
scaleToFit:function scaleToFit(duration){var self=this;var current=self.current;var $what=current.$content;var end;if(!(current.type=='image'&&!current.hasError)||!$what||self.isAnimating){return;}_jquery2.default.fancybox.stop($what);self.isAnimating=true;end=self.getFitPos(current);self.updateCursor(end.width,end.height);_jquery2.default.fancybox.animate($what,{top:end.top,left:end.left,scaleX:end.width/$what.width(),scaleY:end.height/$what.height()},duration||330,function(){self.isAnimating=false;});},// Calculate image size to fit inside viewport
// ===========================================
...
if(_jquery2.default.type(margin)==="number"){margin=[margin,margin];}if(margin.length==2){margin=[margin[0],margin[1],margin[0],margin[1]];}if($W.width()<800){margin=[0,0,0,0];}// We can not use $slide width here, because it can have different diemensions while in transiton
...
// =========================================
update:function update(){var self=this;_jquery2.default.each(self.slides,function(key,slide){self.updateSlide(slide);});},// Update slide position and scale content to fit
// ==============================================
updateSlide:function updateSlide(slide){var self=this;var $what=slide.$content;if($what&&(slide.width||slide.height)){_jquery2.default.fancybox.stop($what);_jquery2.default.fancybox.setTranslate($what,self.getFitPos(slide));if(slide.pos===self.currPos){self.updateCursor();}}slide.$slide.trigger('refresh');self.trigger('onUpdate',slide);},// Update cursor style depending if content can be zoomed
// ======================================================
...
if(current.type==='image'&&current.isLoaded&&!current.hasError&&(current.opts.clickContent==='zoom'||_jquery2.default.isFunction(current.opts.clickContent)&&current.opts.clickContent(current)==="zoom")){fitPos=self.getFitPos(current);if(current.width>fitPos.width||current.height>fitPos.height){return true;}}return false;},// Check if current image dimensions are smaller than actual
// =========================================================
isScaledDown:function isScaledDown(){var self=this;var current=self.current;var $what=current.$content;var rez=false;if($what){rez=_jquery2.default.fancybox.getTranslate($what);rez=rez.width<current.width||rez.height<current.height;}return rez;},// Check if image dimensions exceed parent element
// ===============================================
...
switch(type){case'image':self.setImage(slide);break;case'iframe':self.setIframe(slide);break;case'html':self.setContent(slide,slide.src||slide.content);break;case'inline':if((0,_jquery2.default)(slide.src).length){self.setContent(slide,(0,_jquery2.default)(slide.src));}else{self.setError(slide);}break;case'ajax':self.showLoading(slide);ajaxLoad=_jquery2.default.ajax(_jquery2.default.extend({},slide.opts.ajax.settings,{url:slide.src,success:function success(data,textStatus){if(textStatus==='success'){self.setContent(slide,data);}},error:function error(jqXHR,textStatus){if(jqXHR&&textStatus!=='abort'){self.setError(slide);}}}));$slide.one('onReset',function(){ajaxLoad.abort();});break;default:self.setError(slide);break;}return true;},// Use thumbnail image, if possible
// ================================
setImage:function setImage(slide){var self=this;var srcset=slide.opts.image.srcset;var found,temp,pxRatio,windowWidth;// If we have "srcset", then we need to find matching "src" value.
...
slide.$content=(0,_jquery2.default)('<div class="fancybox-image-wrap"></div>').addClass('fancybox-is-hidden').appendTo(slide.$slide);// If we have a thumbnail, we can display it while actual image is loading
// Users will not stare at black screen and actual image will appear gradually
if(slide.opts.preload!==false&&slide.opts.width&&slide.opts.height&&(slide.opts.thumb||slide.opts.$thumb)){slide.width=slide.opts.width;slide.height=slide.opts.height;slide.$ghost=(0,_jquery2.default)('<img />').one('error',function(){(0,_jquery2.default)(this).remove();slide.$ghost=null;self.setBigImage(slide);}).one('load',function(){self.afterLoad(slide);self.setBigImage(slide);}).addClass('fancybox-image').appendTo(slide.$content).attr('src',slide.opts.thumb||slide.opts.$thumb.attr('src'));}else{self.setBigImage(slide);}},// Create full-size image
// ======================
setBigImage:function setBigImage(slide){var self=this;var $img=(0,_jquery2.default)('<img />');slide.$image=$img.one('error',function(){self.setError(slide);}).one('load',function(){// Clear timeout that checks if loading icon needs to be displayed
...
$wrap.css({'width':opts.css.width===undefined?frameWidth+($wrap.outerWidth()-$wrap.innerWidth()):opts.css.width,'height':opts.css.height===undefined?frameHeight+($wrap.outerHeight()-$wrap.innerHeight()):opts.css.height});}$wrap.removeClass('fancybox-is-hidden');});}else{this.afterLoad(slide);}$iframe.attr('src',slide.src);if(slide.opts.smallBtn===true){slide.$content.prepend(self.translate(slide,slide.opts.btnTpl.smallBtn));}// Remove iframe if closing or changing gallery item
$slide.one('onReset',function(){// This helps IE not to throw errors when closing
try{(0,_jquery2.default)(this).find('iframe').hide().attr('src','//about:blank');}catch(ignore){}(0,_jquery2.default)(this).empty();slide.isLoaded=false;});},// Wrap and append content to the slide
// ======================================
...
slide.$placeholder=(0,_jquery2.default)('<div></div>').hide().insertAfter(content);// Make sure content is visible
content.css('display','inline-block');}else if(!slide.hasError){// If content is just a plain text, try to convert it to html
if(_jquery2.default.type(content)==='string'){content=(0,_jquery2.default)('<div>').append(_jquery2.default.trim(content)).contents();// If we have text node, then add wrapping element to make vertical alignment work
if(content[0].nodeType===3){content=(0,_jquery2.default)('<div>').html(content);}}// If "filter" option is provided, then filter content
if(slide.opts.filter){content=(0,_jquery2.default)('<div>').html(content).find(slide.opts.filter);}}slide.$slide.one('onReset',function(){// Put content back
...
if(!slide.hasError){(0,_jquery2.default)(this).empty();slide.isLoaded=false;}});slide.$content=(0,_jquery2.default)(content).appendTo(slide.$slide);if(slide.opts.smallBtn&&!slide.$smallBtn){slide.$smallBtn=(0,_jquery2.default)(self.translate(slide,slide.opts.btnTpl.smallBtn)).appendTo(slide.$content);}this.afterLoad(slide);},// Display error message
// =====================
...
// ==================================
showLoading:function showLoading(slide){var self=this;slide=slide||self.current;if(slide&&!slide.$spinner){slide.$spinner=(0,_jquery2.default)(self.opts.spinnerTpl).appendTo(slide.$slide);}},// Remove loading icon from the slide
// ==================================
...
// ===============================================
afterLoad:function afterLoad(slide){var self=this;if(self.isClosing){return;}slide.isLoading=false;slide.isLoaded=true;self.trigger('afterLoad',slide);self.hideLoading(slide);if(slide.opts.protect&&slide.$content&&!slide.hasError){// Disable right click
...
if(slide.type==='image'){(0,_jquery2.default)('<div class="fancybox-spaceball"></div>').appendTo(slide.$content);}}self.revealContent(slide);},// Make content visible
...
// ==============
if(effect==='zoom'){end=self.getFitPos(slide);end.scaleX=Math.round(end.width/start.width*100)/100;end.scaleY=Math.round(end.height/start.height*100)/100;delete end.width;delete end.height;// Check if we need to animate opacity
...
_jquery2.default.fancybox.setTranslate(slide.$content.removeClass('fancybox-is-hidden'),start);forceRedraw(slide.$content);// Start animation
_jquery2.default.fancybox.animate(slide.$content,end,duration,function(){self.complete();});return;}self.updateSlide(slide);// Simply show content
// ===================
if(!effect){forceRedraw($slide);slide.$content.removeClass('fancybox-is-hidden');if(slide.pos===self.currPos){self.complete();}return;}_jquery2.default.fancybox.stop($slide);effectClassName='fancybox-animated fancybox-slide--'+(slide.pos>self.prevPos?'next':'previous')+' fancybox-fx-'+effect;$slide.removeAttr('style').removeClass('fancybox-slide--current fancybox-slide--next fancybox-slide--previous').addClass(effectClassName);slide.$content.removeClass('fancybox-is-hidden');//Force reflow for CSS3 transitions
forceRedraw($slide);_jquery2.default.fancybox.animate($slide,'fancybox-slide--current',duration,function(e){$slide.removeClass(effectClassName).removeAttr('style');if(slide.pos===self.currPos){self.complete();}},true);},// Check if we can and have to zoom from thumbnail
//================================================
...
var isElementVisible=function isElementVisible($el){var element=$el[0];var elementRect=element.getBoundingClientRect();var parentRects=[];var visibleInAllParents;while(element.parentElement!==null){if((0,_jquery2.default)(element.parentElement).css('overflow')==='hidden'||(0,_jquery2.default)(element.parentElement).css('overflow')==='auto'){parentRects.push(element.parentElement.getBoundingClientRect());}element=element.parentElement;}visibleInAllParents=parentRects.every(function(parentRect){var visiblePixelX=Math.min(elementRect.right,parentRect.right)-Math.max(elementRect.left,parentRect.left);var visiblePixelY=Math.min(elementRect.bottom,parentRect.bottom)-Math.max(elementRect.top,parentRect.top);return visiblePixelX>0&&visiblePixelY>0;});return visibleInAllParents&&elementRect.bottom>0&&elementRect.right>0&&elementRect.left<(0,_jquery2.default)(window).width()&&elementRect.top<(0,_jquery2.default)(window).height();};var $thumb=slide.opts.$thumb;var thumbPos=$thumb?$thumb.offset():0;var slidePos;if(thumbPos&&$thumb[0].ownerDocument===document&&isElementVisible($thumb)){slidePos=self.$refs.stage.offset();rez={top:thumbPos.top-slidePos.top+parseFloat($thumb.css("border-top-width")||0),left:thumbPos.left-slidePos.left+parseFloat($thumb.css("border-left-width")||0),width:$thumb.width(),height:$thumb.height(),scaleX:1,scaleY:1};}return rez;},// Final adjustments after current gallery item is moved to position
...
_jquery2.default.each(self.slides,function(key,slide){if(slide.pos>=self.currPos-1&&slide.pos<=self.currPos+1){slides[slide.pos]=slide;}else if(slide){_jquery2.default.fancybox.stop(slide.$slide);slide.$slide.unbind().remove();}});self.slides=slides;self.updateCursor();self.trigger('afterShow');// Try to focus on the first focusable element
if((0,_jquery2.default)(document.activeElement).is('[disabled]')||current.opts.autoFocus&&!(current.type=='image'||current.type==='iframe')){self.focus();}},// Preload next and previous slides
// ================================
...
// ====================================================
focus:function focus(){var current=this.current;var $el;if(this.isClosing){return;}// Skip for images and iframes
$el=current&&current.isComplete?current.$slide.find('button,:input,[tabindex],a').filter(':not([disabled]):visible:first'):null;$el=$el&&$el.length?$el:this.$refs.container;$el.focus();},// Activates current instance - brings container to the front and enables keyboard,
// notifies other instances about deactivating
// =================================================================================
activate:function activate(){var self=this;// Deactivate all instances
(0,_jquery2.default)('.fancybox-container').each(function(){var instance=(0,_jquery2.default)(this).data('FancyBox');// Skip self and closing instances
...
self.removeEvents();if(current.timouts){clearTimeout(current.timouts);}$what=current.$content;effect=current.opts.animationEffect;duration=_jquery2.default.isNumeric(d)?d:effect?current.opts.animationDuration:0;// Remove other slides
...
if(effect==='zoom'&&!(e!==true&&$what&&duration&&current.type==='image'&&!current.hasError&&(end=self.getThumbPos(current)))){effect='fade';}if(effect==='zoom'){_jquery2.default.fancybox.stop($what);start=_jquery2.default.fancybox.getTranslate($what);start.width=start.width*start.scaleX;start.height=start.height*start.scaleY;// Check if we need to animate opacity
opacity=current.opts.zoomOpacity;if(opacity=='auto'){opacity=Math.abs(current.width/current.height-end.width/end.height)>0.1;}if(opacity){end.opacity=0;}start.scaleX=start.width/end.width;start.scaleY=start.height/end.height;start.width=end.width;start.height=end.height;_jquery2.default.fancybox.setTranslate(current.$content,start);_jquery2.default.fancybox.animate(current.$content,end,duration,done);return true;}if(effect&&duration){// If skip animation
if(e===true){setTimeout(done,duration);}else{_jquery2.default.fancybox.animate(current.$slide.removeClass('fancybox-slide--current'),'fancybox-animated fancybox-slide--previous fancybox-fx-'+effect,duration,done);}}else{done();}return true;},// Final adjustments after removing the instance
// =============================================
cleanUp:function cleanUp(e){var self=this,instance;self.current.$slide.trigger('onReset');self.$refs.container.empty().remove();self.trigger('afterClose',e);// Place back focus
if(self.$lastFocus&&!!!self.current.focusBack){self.$lastFocus.focus();}self.current=null;// Check if there are other instances
instance=_jquery2.default.fancybox.getInstance();if(instance){instance.activate();}else{$W.scrollTop(self.scrollTop).scrollLeft(self.scrollLeft);(0,_jquery2.default)('html').removeClass('fancybox-enabled');(0,_jquery2.default)('#fancybox-style-noscroll').remove();}},// Call callback and trigger an event
// ==================================
trigger:function trigger(name,slide){var args=Array.prototype.slice.call(arguments,1),self=this,obj=slide&&slide.opts?slide:self.current,rez;if(obj){args.unshift(obj);}else{obj=self;}args.unshift(self);if(_jquery2.default.isFunction(obj.opts[name])){rez=obj.opts[name].apply(obj,args);}if(rez===false){return rez;}if(name==='afterClose'){$D.trigger(name+'.fb',args);}else{self.$refs.container.trigger(name+'.fb',args);}},// Update infobar values, navigation button states and reveal caption
// ==================================================================
updateControls:function updateControls(force){var self=this;var current=self.current;var index=current.index;var opts=current.opts;var caption=opts.caption;var $caption=self.$refs.caption;// Recalculate content dimensions
current.$slide.trigger('refresh');self.$caption=caption&&caption.length?$caption.html(caption):null;if(!self.isHiddenControls){self.showControls();}// Update info and navigation elements
(0,_jquery2.default)('[data-fancybox-count]').html(self.group.length);(0,_jquery2.default)('[data-fancybox-index]').html(index+1);(0,_jquery2.default)('[data-fancybox-prev]').prop('disabled',!opts.loop&&index<=0);(0,_jquery2.default)('[data-fancybox-next]').prop('disabled',!opts.loop&&index>=self.group.length-1);},// Hide toolbar and caption
// ========================
...
// ==========================
toggleControls:function toggleControls(){if(this.isHiddenControls){this.showControls();}else{this.hideControls();}}});_jquery2.default.fancybox={version:"3.1.20",defaults:defaults,// Get current instance and execute a command.
//
// Examples of usage:
//
...
//   });
// ======================================================
getInstance:function getInstance(command){var instance=(0,_jquery2.default)('.fancybox-container:not(".fancybox-is-closing"):first').data('FancyBox');var args=Array.prototype.slice.call(arguments,1);if(instance instanceof FancyBox){if(_jquery2.default.type(command)==='string'){instance[command].apply(instance,args);}else if(_jquery2.default.type(command)==='function'){command.apply(instance,args);}return instance;}return false;},// Create new instance
// ===================
...
// ============================
isMobile:document.createTouch!==undefined&&/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent),// Detect if 'translate3d' support is available
// ============================================
...
// =============================
animate:function animate($el,to,duration,callback,leaveAnimationName){var event=transitionEnd||'transitionend';if(_jquery2.default.isFunction(duration)){callback=duration;duration=null;}if(!_jquery2.default.isPlainObject(to)){$el.removeAttr('style');}$el.on(event,function(e){// Skip events from child elements and z-index change
if(e&&e.originalEvent&&(!$el.is(e.originalEvent.target)||e.originalEvent.propertyName=='z-index')){return;}$el.off(event);if(_jquery2.default.isPlainObject(to)){if(to.scaleX!==undefined&&to.scaleY!==undefined){$el.css('transition-duration','0ms');to.width=$el.width()*to.scaleX;to.height=$el.height()*to.scaleY;to.scaleX=1;to.scaleY=1;_jquery2.default.fancybox.setTranslate($el,to);}}else if(leaveAnimationName!==true){$el.removeClass(to);}if(_jquery2.default.isFunction(callback)){callback(e);}});if(_jquery2.default.isNumeric(duration)){$el.css('transition-duration',duration+'ms');}if(_jquery2.default.isPlainObject(to)){_jquery2.default.fancybox.setTranslate($el,to);}else{$el.addClass(to);}$el.data("timer",setTimeout(function(){$el.trigger('transitionend');},duration+16));},stop:function stop($el){clearTimeout($el.data("timer"));$el.off(transitionEnd);}};// Default click handler for "fancyboxed" links
// ============================================
function _run(e){var target=e.currentTarget,opts=e.data?e.data.options:{},items=e.data?e.data.items:[],value=(0,_jquery2.default)(target).attr('data-fancybox')||'',index=0;e.preventDefault();e.stopPropagation();// Get all related items and find index for clicked one
if(value){items=items.length?items.filter('[data-fancybox="'+value+'"]'):(0,_jquery2.default)('[data-fancybox="'+value+'"]');index=items.index(target);// Sometimes current item can not be found
// (for example, when slider clones items)
if(index<0){index=0;}}else{items=[target];}_jquery2.default.fancybox.open(items,opts,index);}// Create a jQuery plugin
// ======================
_jquery2.default.fn.fancybox=function(options){var selector;options=options||{};selector=options.selector||false;if(selector){(0,_jquery2.default)('body').off('click.fb-start',selector).on('click.fb-start',selector,{items:(0,_jquery2.default)(selector),options:options},_run);}else{this.off('click.fb-start').on('click.fb-start',{items:this,options:options},_run);}return this;};// Self initializing plugin
// ========================
$D.on('click.fb-start','[data-fancybox]',_run);})(window,document);// ==========================================================================
//
// Media
// Adds additional media type support
//
// ==========================================================================
;(function(window){'use strict';// Formats matching url to final form
var format=function format(url,rez,params){if(!url){return;}params=params||'';if(_jquery2.default.type(params)==="object"){params=_jquery2.default.param(params,true);}_jquery2.default.each(rez,function(key,value){url=url.replace('$'+key,value||'');});if(params.length){url+=(url.indexOf('?')>0?'&':'?')+params;}return url;};// Object containing properties for each media type
...
google_maps:{matcher:/(maps\.)?google\.([a-z]{2,3}(\.[a-z]{2})?)\/(((maps\/(place\/(.*)\/)?\@(.*),(\d+.?\d+?)z))|(\?ll=))(.*)?/i,type:'iframe',url:function url(rez){return'//maps.google.'+rez[2]+'/?ll='+(rez[9]?rez[9]+'&z='+Math.floor(rez[10])+(rez[12]?rez[12].replace(/^\//,"&"):''):rez[12])+'&output='+(rez[12]&&rez[12].indexOf('layer=c')>0?'svembed':'embed');}}};(0,_jquery2.default)(document).on('onInit.fb',function(e,instance){_jquery2.default.each(instance.group,function(i,item){var url=item.src||'',type=false,media,thumb,rez,params,urlParams,o,provider;// Skip items that already have content type
if(item.type){return;}media=_jquery2.default.extend(true,{},defaults,item.opts.media);// Look for any matching media type
_jquery2.default.each(media,function(n,el){rez=url.match(el.matcher);o={};provider=n;if(!rez){return;}type=el.type;if(el.paramPlace&&rez[el.paramPlace]){urlParams=rez[el.paramPlace];if(urlParams[0]=='?'){urlParams=urlParams.substring(1);}urlParams=urlParams.split('&');for(var m=0;m<urlParams.length;++m){var p=urlParams[m].split('=',2);if(p.length==2){o[p[0]]=decodeURIComponent(p[1].replace(/\+/g," "));}}}params=_jquery2.default.extend(true,{},el.params,item.opts[n],o);url=_jquery2.default.type(el.url)==="function"?el.url.call(this,rez,params,item):format(el.url,rez,params);thumb=_jquery2.default.type(el.thumb)==="function"?el.thumb.call(this,rez,params,item):format(el.thumb,rez);if(provider==='vimeo'){url=url.replace('&%23','#');}return false;});// If it is found, then change content type and update the url
if(type){item.src=url;item.type=type;if(!item.opts.thumb&&!(item.opts.$thumb&&item.opts.$thumb.length)){item.opts.thumb=thumb;}if(type==='iframe'){_jquery2.default.extend(true,item.opts,{iframe:{preload:false,attr:{scrolling:"no"}}});item.contentProvider=provider;item.opts.slideClass+=' fancybox-slide--'+(provider=='google_maps'?'map':'video');}}else{// If no content type is found, then set it to `image` as fallback
item.type='image';}});});})(window);// ==========================================================================
//
// Guestures
...
if(!self.startPoints||self.startPoints.length>1&&instance.isSliding){return;}self.$target=$target;self.$content=$content;self.canTap=true;(0,_jquery2.default)(document).off('.fb.touch');(0,_jquery2.default)(document).on(isTouchDevice?'touchend.fb.touch touchcancel.fb.touch':'mouseup.fb.touch mouseleave.fb.touch',_jquery2.default.proxy(self,"ontouchend"));(0,_jquery2.default)(document).on(isTouchDevice?'touchmove.fb.touch':'mousemove.fb.touch',_jquery2.default.proxy(self,"ontouchmove"));e.stopPropagation();if(!(instance.current.opts.touch||instance.canPan())||!($target.is(self.$stage)||self.$stage.find($target).length)){// Prevent ghosting
if($target.is('img')){e.preventDefault();}return;}if(!(_jquery2.default.fancybox.isMobile&&(isScrollable(self.$target)||isScrollable(self.$target.parent())))){e.preventDefault();}self.canvasWidth=Math.round(current.$slide[0].clientWidth);self.canvasHeight=Math.round(current.$slide[0].clientHeight);self.startTime=new Date().getTime();self.distanceX=self.distanceY=self.distance=0;self.isPanning=false;self.isSwiping=false;self.isZooming=false;self.sliderStartPos=self.sliderLastPos||{top:0,left:0};self.contentStartPos=_jquery2.default.fancybox.getTranslate(self.$content);self.contentLastPos=null;if(self.startPoints.length===1&&!self.isZooming){self.canTap=!instance.isSliding;if(current.type==='image'&&(self.contentStartPos.width>self.canvasWidth+1||self.contentStartPos.height>self.canvasHeight+1)){_jquery2.default.fancybox.stop(self.$content);self.$content.css('transition-duration','0ms');self.isPanning=true;}else{self.isSwiping=true;}self.$container.addClass('fancybox-controls--isGrabbing');}if(self.startPoints.length===2&&!instance.isAnimating&&!current.hasError&&current.type==='image'&&(current.isLoaded||current.$ghost)){self.isZooming=true;self.isSwiping=false;self.isPanning=false;_jquery2.default.fancybox.stop(self.$content);self.$content.css('transition-duration','0ms');self.centerPointStartX=(self.startPoints[0].x+self.startPoints[1].x)*0.5-(0,_jquery2.default)(window).scrollLeft();self.centerPointStartY=(self.startPoints[0].y+self.startPoints[1].y)*0.5-(0,_jquery2.default)(window).scrollTop();self.percentageOfImageAtPinchPointX=(self.centerPointStartX-self.contentStartPos.left)/self.contentStartPos.width;self.percentageOfImageAtPinchPointY=(self.centerPointStartY-self.contentStartPos.top)/self.contentStartPos.height;self.startDistanceBetweenFingers=distance(self.startPoints[0],self.startPoints[1]);}};Guestures.prototype.ontouchmove=function(e){var self=this;self.newPoints=pointers(e);if(_jquery2.default.fancybox.isMobile&&(isScrollable(self.$target)||isScrollable(self.$target.parent()))){e.stopPropagation();self.canTap=false;return;}if(!(self.instance.current.opts.touch||self.instance.canPan())||!self.newPoints||!self.newPoints.length){return;}self.distanceX=distance(self.newPoints[0],self.startPoints[0],'x');self.distanceY=distance(self.newPoints[0],self.startPoints[0],'y');self.distance=distance(self.newPoints[0],self.startPoints[0]);// Skip false ontouchmove events (Chrome)
if(self.distance>0){if(!(self.$target.is(self.$stage)||self.$stage.find(self.$target).length)){return;}e.stopPropagation();e.preventDefault();if(self.isSwiping){self.onSwipe();}else if(self.isPanning){self.onPan();}else if(self.isZooming){self.onZoom();}}};Guestures.prototype.onSwipe=function(){var self=this;var swiping=self.isSwiping;var left=self.sliderStartPos.left||0;var angle;if(swiping===true){if(Math.abs(self.distance)>10){self.canTap=false;if(self.instance.group.length<2&&self.instance.opts.touch.vertical){self.isSwiping='y';}else if(self.instance.isSliding||self.instance.opts.touch.vertical===false||self.instance.opts.touch.vertical==='auto'&&(0,_jquery2.default)(window).width()>800){self.isSwiping='x';}else{angle=Math.abs(Math.atan2(self.distanceY,self.distanceX)*180/Math.PI);self.isSwiping=angle>45&&angle<135?'y':'x';}self.instance.isSliding=self.isSwiping;// Reset points to avoid jumping, because we dropped first swipes to calculate the angle
self.startPoints=self.newPoints;_jquery2.default.each(self.instance.slides,function(index,slide){_jquery2.default.fancybox.stop(slide.$slide);slide.$slide.css('transition-duration','0ms');slide.inTransition=false;if(slide.pos===self.instance.current.pos){self.sliderStartPos.left=_jquery2.default.fancybox.getTranslate(slide.$slide).left;}});//self.instance.current.isMoved = true;
// Stop slideshow
if(self.instance.SlideShow&&self.instance.SlideShow.isActive){self.instance.SlideShow.stop();}}}else{if(swiping=='x'){// Sticky edges
if(self.distanceX>0&&(self.instance.group.length<2||self.instance.current.index===0&&!self.instance.current.opts.loop)){left=left+Math.pow(self.distanceX,0.8);}else if(self.distanceX<0&&(self.instance.group.length<2||self.instance.current.index===self.instance.group.length-1&&!self.instance.current.opts.loop)){left=left-Math.pow(-self.distanceX,0.8);}else{left=left+self.distanceX;}}self.sliderLastPos={top:swiping=='x'?0:self.sliderStartPos.top+self.distanceY,left:left};if(self.requestId){cancelAFrame(self.requestId);self.requestId=null;}self.requestId=requestAFrame(function(){if(self.sliderLastPos){_jquery2.default.each(self.instance.slides,function(index,slide){var pos=slide.pos-self.instance.currPos;_jquery2.default.fancybox.setTranslate(slide.$slide,{top:self.sliderLastPos.top,left:self.sliderLastPos.left+pos*self.canvasWidth+pos*slide.opts.gutter});});self.$container.addClass('fancybox-is-sliding');}});}};Guestures.prototype.onPan=function(){var self=this;var newOffsetX,newOffsetY,newPos;self.canTap=false;if(self.contentStartPos.width>self.canvasWidth){newOffsetX=self.contentStartPos.left+self.distanceX;}else{newOffsetX=self.contentStartPos.left;}newOffsetY=self.contentStartPos.top+self.distanceY;newPos=self.limitMovement(newOffsetX,newOffsetY,self.contentStartPos.width,self.contentStartPos.height);newPos.scaleX=self.contentStartPos.scaleX;newPos.scaleY=self.contentStartPos.scaleY;self.contentLastPos=newPos;if(self.requestId){cancelAFrame(self.requestId);self.requestId=null;}self.requestId=requestAFrame(function(){_jquery2.default.fancybox.setTranslate(self.$content,self.contentLastPos);});};// Make panning sticky to the edges
...
var centerPointEndX=(self.newPoints[0].x+self.newPoints[1].x)/2-(0,_jquery2.default)(window).scrollLeft();var centerPointEndY=(self.newPoints[0].y+self.newPoints[1].y)/2-(0,_jquery2.default)(window).scrollTop();// And this is the translation due to translation of the centerpoint
...
var newOffsetX=currentOffsetX+(translateFromZoomingX+translateFromTranslatingX);var newOffsetY=currentOffsetY+(translateFromZoomingY+translateFromTranslatingY);var newPos={top:newOffsetY,left:newOffsetX,scaleX:self.contentStartPos.scaleX*pinchRatio,scaleY:self.contentStartPos.scaleY*pinchRatio};self.canTap=false;self.newWidth=newWidth;self.newHeight=newHeight;self.contentLastPos=newPos;if(self.requestId){cancelAFrame(self.requestId);self.requestId=null;}self.requestId=requestAFrame(function(){_jquery2.default.fancybox.setTranslate(self.$content,self.contentLastPos);});};Guestures.prototype.ontouchend=function(e){var self=this;var dMs=Math.max(new Date().getTime()-self.startTime,1);var swiping=self.isSwiping;var panning=self.isPanning;var zooming=self.isZooming;self.endPoints=pointers(e);self.$container.removeClass('fancybox-controls--isGrabbing');(0,_jquery2.default)(document).off('.fb.touch');if(self.requestId){cancelAFrame(self.requestId);self.requestId=null;}self.isSwiping=false;self.isPanning=false;self.isZooming=false;if(self.canTap){return self.onTap(e);}self.speed=366;// Speed in px/ms
...
_jquery2.default.fancybox.animate(self.instance.current.$slide,{top:self.sliderStartPos.top+self.distanceY+self.velocityY*150,opacity:0},150);ret=self.instance.close(true,300);}else if(swiping=='x'&&self.distanceX>50&&self.instance.group.length>1){ret=self.instance.previous(self.speedX);}else if(swiping=='x'&&self.distanceX<-50&&self.instance.group.length>1){ret=self.instance.next(self.speedX);}if(ret===false&&(swiping=='x'||swiping=='y')){self.instance.jumpTo(self.instance.current.index,150);}self.$container.removeClass('fancybox-is-sliding');};// Limit panning from edges
// ========================
Guestures.prototype.endPanning=function(){var self=this;var newOffsetX,newOffsetY,newPos;if(!self.contentLastPos){return;}if(self.instance.current.opts.touch.momentum===false){newOffsetX=self.contentLastPos.left;newOffsetY=self.contentLastPos.top;}else{// Continue movement
newOffsetX=self.contentLastPos.left+self.velocityX*self.speed;newOffsetY=self.contentLastPos.top+self.velocityY*self.speed;}newPos=self.limitPosition(newOffsetX,newOffsetY,self.contentStartPos.width,self.contentStartPos.height);newPos.width=self.contentStartPos.width;newPos.height=self.contentStartPos.height;_jquery2.default.fancybox.animate(self.$content,newPos,330);};Guestures.prototype.endZooming=function(){var self=this;var current=self.instance.current;var newOffsetX,newOffsetY,newPos,reset;var newWidth=self.newWidth;var newHeight=self.newHeight;if(!self.contentLastPos){return;}newOffsetX=self.contentLastPos.left;newOffsetY=self.contentLastPos.top;reset={top:newOffsetY,left:newOffsetX,width:newWidth,height:newHeight,scaleX:1,scaleY:1};// Reset scalex/scaleY values; this helps for perfomance and does not break animation
_jquery2.default.fancybox.setTranslate(self.$content,reset);if(newWidth<self.canvasWidth&&newHeight<self.canvasHeight){self.instance.scaleToFit(150);}else if(newWidth>current.width||newHeight>current.height){self.instance.scaleToActual(self.centerPointStartX,self.centerPointStartY,150);}else{newPos=self.limitPosition(newOffsetX,newOffsetY,newWidth,newHeight);// Switch from scale() to width/height or animation will not work correctly
_jquery2.default.fancybox.setTranslate(self.content,_jquery2.default.fancybox.getTranslate(self.$content));_jquery2.default.fancybox.animate(self.$content,newPos,150);}};Guestures.prototype.onTap=function(e){var self=this;var $target=(0,_jquery2.default)(e.target);var instance=self.instance;var current=instance.current;var endPoints=e&&pointers(e)||self.startPoints;var tapX=endPoints[0]?endPoints[0].x-self.$stage.offset().left:0;var tapY=endPoints[0]?endPoints[0].y-self.$stage.offset().top:0;var where;var process=function process(prefix){var action=current.opts[prefix];if(_jquery2.default.isFunction(action)){action=action.apply(instance,[current,e]);}if(!action){return;}switch(action){case"close":instance.close(self.startEvent);break;case"toggleControls":instance.toggleControls(true);break;case"next":instance.next();break;case"nextOrClose":if(instance.group.length>1){instance.next();}else{instance.close(self.startEvent);}break;case"zoom":if(current.type=='image'&&(current.isLoaded||current.$ghost)){if(instance.canPan()){instance.scaleToFit();}else if(instance.isScaledDown()){instance.scaleToActual(tapX,tapY);}else if(instance.group.length<2){instance.close(self.startEvent);}}break;}};// Ignore right click
...
self.tapX=tapX;self.tapY=tapY;if(current.opts['dblclick'+where]&&current.opts['dblclick'+where]!==current.opts['click'+where]){self.tapped=setTimeout(function(){self.tapped=null;process('click'+where);},300);}else{process('click'+where);}}return this;};(0,_jquery2.default)(document).on('onActivate.fb',function(e,instance){if(instance&&!instance.Guestures){instance.Guestures=new Guestures(instance);}});(0,_jquery2.default)(document).on('beforeClose.fb',function(e,instance){if(instance&&instance.Guestures){instance.Guestures.destroy();}});})(window,document);// ==========================================================================
//
// SlideShow
...
//
// ==========================================================================
;(function(document){'use strict';var SlideShow=function SlideShow(instance){this.instance=instance;this.init();};_jquery2.default.extend(SlideShow.prototype,{timer:null,isActive:false,$button:null,speed:3000,init:function init(){var self=this;self.$button=self.instance.$refs.toolbar.find('[data-fancybox-play]').on('click',function(){self.toggle();});if(self.instance.group.length<2||!self.instance.group[self.instance.currIndex].opts.slideShow){self.$button.hide();}},set:function set(){var self=this;// Check if reached last element
if(self.instance&&self.instance.current&&(self.instance.current.opts.loop||self.instance.currIndex<self.instance.group.length-1)){self.timer=setTimeout(function(){self.instance.next();},self.instance.current.opts.slideShow.speed||self.speed);}else{self.stop();self.instance.idleSecondsCounter=0;self.instance.showControls();}},clear:function clear(){var self=this;clearTimeout(self.timer);self.timer=null;},start:function start(){var self=this;var current=self.instance.current;if(self.instance&&current&&(current.opts.loop||current.index<self.instance.group.length-1)){self.isActive=true;self.$button.attr('title',current.opts.i18n[current.opts.lang].PLAY_STOP).addClass('fancybox-button--pause');if(current.isComplete){self.set();}}},stop:function stop(){var self=this;var current=self.instance.current;self.clear();self.$button.attr('title',current.opts.i18n[current.opts.lang].PLAY_START).removeClass('fancybox-button--pause');self.isActive=false;},toggle:function toggle(){var self=this;if(self.isActive){self.stop();}else{self.start();}}});(0,_jquery2.default)(document).on({'onInit.fb':function onInitFb(e,instance){if(instance&&!instance.SlideShow){instance.SlideShow=new SlideShow(instance);}},'beforeShow.fb':function beforeShowFb(e,instance,current,firstRun){var SlideShow=instance&&instance.SlideShow;if(firstRun){if(SlideShow&&current.opts.slideShow.autoStart){SlideShow.start();}}else if(SlideShow&&SlideShow.isActive){SlideShow.clear();}},'afterShow.fb':function afterShowFb(e,instance,current){var SlideShow=instance&&instance.SlideShow;if(SlideShow&&SlideShow.isActive){SlideShow.set();}},'afterKeydown.fb':function afterKeydownFb(e,instance,current,keypress,keycode){var SlideShow=instance&&instance.SlideShow;// "P" or Spacebar
if(SlideShow&&current.opts.slideShow&&(keycode===80||keycode===32)&&!(0,_jquery2.default)(document.activeElement).is('button,a,input')){keypress.preventDefault();SlideShow.toggle();}},'beforeClose.fb onDeactivate.fb':function beforeCloseFbOnDeactivateFb(e,instance){var SlideShow=instance&&instance.SlideShow;if(SlideShow){SlideShow.stop();}}});// Page Visibility API to pause slideshow when window is not active
(0,_jquery2.default)(document).on("visibilitychange",function(){var instance=_jquery2.default.fancybox.getInstance();var SlideShow=instance&&instance.SlideShow;if(SlideShow&&SlideShow.isActive){if(document.hidden){SlideShow.clear();}else{SlideShow.set();}}});})(document);// ==========================================================================
//
// FullScreen
...
if(!fn){_jquery2.default.fancybox.defaults.btnTpl.fullScreen=false;return;}var FullScreen={request:function request(elem){elem=elem||document.documentElement;elem[fn.requestFullscreen](elem.ALLOW_KEYBOARD_INPUT);},exit:function exit(){document[fn.exitFullscreen]();},toggle:function toggle(elem){elem=elem||document.documentElement;if(this.isFullscreen()){this.exit();}else{this.request(elem);}},isFullscreen:function isFullscreen(){return Boolean(document[fn.fullscreenElement]);},enabled:function enabled(){return Boolean(document[fn.fullscreenEnabled]);}};(0,_jquery2.default)(document).on({'onInit.fb':function onInitFb(e,instance){var $container;var $button=instance.$refs.toolbar.find('[data-fancybox-fullscreen]');if(instance&&!instance.FullScreen&&instance.group[instance.currIndex].opts.fullScreen){$container=instance.$refs.container;$container.on('click.fb-fullscreen','[data-fancybox-fullscreen]',function(e){e.stopPropagation();e.preventDefault();FullScreen.toggle($container[0]);});if(instance.opts.fullScreen&&instance.opts.fullScreen.autoStart===true){FullScreen.request($container[0]);}// Expose API
instance.FullScreen=FullScreen;}else{$button.hide();}},'afterKeydown.fb':function afterKeydownFb(e,instance,current,keypress,keycode){// "P" or Spacebar
if(instance&&instance.FullScreen&&keycode===70){keypress.preventDefault();instance.FullScreen.toggle(instance.$refs.container[0]);}},'beforeClose.fb':function beforeCloseFb(instance){if(instance&&instance.FullScreen){FullScreen.exit();}}});(0,_jquery2.default)(document).on(fn.fullscreenchange,function(){var instance=_jquery2.default.fancybox.getInstance();// If image is zooming, then force to stop and reposition properly
if(instance.current&&instance.current.type==='image'&&instance.isAnimating){instance.current.$content.css('transition','none');instance.isAnimating=false;instance.update(true,true,0);}});})(document);// ==========================================================================
//
// Thumbs
// Displays thumbnails in a grid
//
// ==========================================================================
;(function(document){'use strict';var FancyThumbs=function FancyThumbs(instance){this.instance=instance;this.init();};_jquery2.default.extend(FancyThumbs.prototype,{$button:null,$grid:null,$list:null,isVisible:false,init:function init(){var self=this;var first=self.instance.group[0],second=self.instance.group[1];self.$button=self.instance.$refs.toolbar.find('[data-fancybox-thumbs]');if(self.instance.group.length>1&&self.instance.group[self.instance.currIndex].opts.thumbs&&(first.type=='image'||first.opts.thumb||first.opts.$thumb)&&(second.type=='image'||second.opts.thumb||second.opts.$thumb)){self.$button.on('click',function(){self.toggle();});self.isActive=true;}else{self.$button.hide();self.isActive=false;}},create:function create(){var instance=this.instance,list,src;this.$grid=(0,_jquery2.default)('<div class="fancybox-thumbs"></div>').appendTo(instance.$refs.container);list='<ul>';_jquery2.default.each(instance.group,function(i,item){src=item.opts.thumb||(item.opts.$thumb?item.opts.$thumb.attr('src'):null);if(!src&&item.type==='image'){src=item.src;}if(src&&src.length){list+='<li data-index="'+i+'"  tabindex="0" class="fancybox-thumbs-loading"><img data-src="'+src+'" /></li>';}});list+='</ul>';this.$list=(0,_jquery2.default)(list).appendTo(this.$grid).on('click','li',function(){instance.jumpTo((0,_jquery2.default)(this).data('index'));});this.$list.find('img').hide().one('load',function(){var $parent=(0,_jquery2.default)(this).parent().removeClass('fancybox-thumbs-loading'),thumbWidth=$parent.outerWidth(),thumbHeight=$parent.outerHeight(),width,height,widthRatio,heightRatio;width=this.naturalWidth||this.width;height=this.naturalHeight||this.height;//Calculate thumbnail width/height and center it
widthRatio=width/thumbWidth;heightRatio=height/thumbHeight;if(widthRatio>=1&&heightRatio>=1){if(widthRatio>heightRatio){width=width/heightRatio;height=thumbHeight;}else{width=thumbWidth;height=height/widthRatio;}}(0,_jquery2.default)(this).css({width:Math.floor(width),height:Math.floor(height),'margin-top':Math.min(0,Math.floor(thumbHeight*0.3-height*0.3)),'margin-left':Math.min(0,Math.floor(thumbWidth*0.5-width*0.5))}).show();}).each(function(){this.src=(0,_jquery2.default)(this).data('src');});},focus:function focus(){if(this.instance.current){this.$list.children().removeClass('fancybox-thumbs-active').filter('[data-index="'+this.instance.current.index+'"]').addClass('fancybox-thumbs-active').focus();}},close:function close(){this.$grid.hide();},update:function update(){this.instance.$refs.container.toggleClass('fancybox-show-thumbs',this.isVisible);if(this.isVisible){if(!this.$grid){this.create();}this.instance.trigger('onThumbsShow');this.focus();}else if(this.$grid){this.instance.trigger('onThumbsHide');}// Update content position
this.instance.update();},hide:function hide(){this.isVisible=false;this.update();},show:function show(){this.isVisible=true;this.update();},toggle:function toggle(){this.isVisible=!this.isVisible;this.update();}});(0,_jquery2.default)(document).on({'onInit.fb':function onInitFb(e,instance){if(instance&&!instance.Thumbs){instance.Thumbs=new FancyThumbs(instance);}},'beforeShow.fb':function beforeShowFb(e,instance,item,firstRun){var Thumbs=instance&&instance.Thumbs;if(!Thumbs||!Thumbs.isActive){return;}if(item.modal){Thumbs.$button.hide();Thumbs.hide();return;}if(firstRun&&instance.opts.thumbs.autoStart===true){Thumbs.show();}if(Thumbs.isVisible){Thumbs.focus();}},'afterKeydown.fb':function afterKeydownFb(e,instance,current,keypress,keycode){var Thumbs=instance&&instance.Thumbs;// "G"
if(Thumbs&&Thumbs.isActive&&keycode===71){keypress.preventDefault();Thumbs.toggle();}},'beforeClose.fb':function beforeCloseFb(e,instance){var Thumbs=instance&&instance.Thumbs;if(Thumbs&&Thumbs.isVisible&&instance.opts.thumbs.hideOnClose!==false){Thumbs.close();}}});})(document);// ==========================================================================
//
// Hash
...
if(!_jquery2.default.escapeSelector){_jquery2.default.escapeSelector=function(sel){var rcssescape=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;var fcssescape=function fcssescape(ch,asCodePoint){if(asCodePoint){// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
if(ch==="\0"){return'\uFFFD';}// Control characters and (dependent upon position) numbers get escaped as code points
return ch.slice(0,-1)+"\\"+ch.charCodeAt(ch.length-1).toString(16)+" ";}// Other potentially-special ASCII characters get backslash-escaped
...
$el=(0,_jquery2.default)("[data-fancybox='"+_jquery2.default.escapeSelector(url.gallery)+"']").eq(url.index-1);if($el.length){$el.trigger('click');}else{// .. if not, try finding element by ID
(0,_jquery2.default)("#"+_jquery2.default.escapeSelector(url.gallery)+"").trigger('click');}}}// Get gallery name from current instance
...
(0,_jquery2.default)(function(){// Small delay is used to allow other scripts to process "dom ready" event
setTimeout(function(){// Check if this module is not disabled
if(_jquery2.default.fancybox.defaults.hash===false){return;}// Update hash when opening/closing fancyBox
(0,_jquery2.default)(document).on({'onInit.fb':function onInitFb(e,instance){var url,gallery;if(instance.group[instance.currIndex].opts.hash===false){return;}url=parseUrl();gallery=getGallery(instance);// Make sure gallery start index matches index from hash
if(gallery&&url.gallery&&gallery==url.gallery){instance.currIndex=url.index-1;}},'beforeShow.fb':function beforeShowFb(e,instance,current,firstRun){var gallery;if(current.opts.hash===false){return;}gallery=getGallery(instance);// Update window hash
if(gallery&&gallery!==''){if(window.location.hash.indexOf(gallery)<0){instance.opts.origHash=window.location.hash;}currentHash=gallery+(instance.group.length>1?'-'+(current.index+1):'');if('replaceState'in window.history){if(timerID){clearTimeout(timerID);}timerID=setTimeout(function(){window.history[firstRun?'pushState':'replaceState']({},document.title,window.location.pathname+window.location.search+'#'+currentHash);timerID=null;},300);}else{window.location.hash=currentHash;}}},'beforeClose.fb':function beforeCloseFb(e,instance,current){var gallery,origHash;if(timerID){clearTimeout(timerID);}if(current.opts.hash===false){return;}gallery=getGallery(instance);origHash=instance&&instance.opts.origHash?instance.opts.origHash:'';// Remove hash from location bar
...
(0,_jquery2.default)(window).scrollTop(instance.scrollTop).scrollLeft(instance.scrollLeft);}}currentHash=null;}});// Check if need to close after url has changed
(0,_jquery2.default)(window).on('hashchange.fb',function(){var url=parseUrl();if(_jquery2.default.fancybox.getInstance()){if(currentHash&&currentHash!==url.gallery+'-'+url.index&&!(url.index===1&&currentHash==url.gallery)){currentHash=null;_jquery2.default.fancybox.close();}}else if(url.gallery!==''){triggerFromUrl(url);}});// If navigating away from current page
(0,_jquery2.default)(window).one('unload.fb popstate.fb',function(){_jquery2.default.fancybox.getInstance('close',true,0);});// Check current hash and trigger click event on matching element to start fancyBox, if needed
triggerFromUrl(parseUrl());},50);});})(document,window);
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */function Owl(element,options){/**
		 ...
		 * @public
		 */this.options=_jquery2.default.extend({},Owl.Defaults,options);/**
		 * Plugin element.
		 * @public
		 ...
		 * @type {Object}
		 * @protected
		 */this._states={current:{},tags:{'initializing':['busy'],'animating':['busy'],'dragging':['interacting']}};_jquery2.default.each(['onResize','onThrottledResize'],_jquery2.default.proxy(function(i,handler){this._handlers[handler]=_jquery2.default.proxy(this[handler],this);},this));_jquery2.default.each(Owl.Plugins,_jquery2.default.proxy(function(key,plugin){this._plugins[key.charAt(0).toLowerCase()+key.slice(1)]=new plugin(this);},this));_jquery2.default.each(Owl.Workers,_jquery2.default.proxy(function(priority,worker){this._pipe.push({'filter':worker.filter,'run':_jquery2.default.proxy(worker.run,this)});},this));this.setup();this.initialize();}/**
...
this.$stage=(0,_jquery2.default)('<'+this.settings.stageElement+' class="'+this.settings.stageClass+'"/>').wrap('<div class="'+this.settings.stageOuterClass+'"/>');// append stage
...
this.registerEventHandlers();this.leave('initializing');this.trigger('initialized');};/**
	 ...
	 * @public
	 */Owl.prototype.setup=function(){var viewport=this.viewport(),overwrites=this.options.responsive,match=-1,settings=null;if(!overwrites){settings=_jquery2.default.extend({},this.options);}else{_jquery2.default.each(overwrites,function(breakpoint){if(breakpoint<=viewport&&breakpoint>match){match=Number(breakpoint);}});settings=_jquery2.default.extend({},this.options,overwrites[match]);if(typeof settings.stagePadding==='function'){settings.stagePadding=settings.stagePadding();}delete settings.responsive;// responsive class
if(settings.responsiveClass){this.$element.attr('class',this.$element.attr('class').replace(new RegExp('('+this.options.responsiveClass+'-)\\S+\\s','g'),'$1'+match));}}this.trigger('change',{property:{name:'settings',value:settings}});this._breakpoint=match;this.settings=settings;this.invalidate('settings');this.trigger('changed',{property:{name:'settings',value:this.settings}});};/**
	 ...
	 */Owl.prototype.prepare=function(item){var event=this.trigger('prepare',{content:item});if(!event.data){event.data=(0,_jquery2.default)('<'+this.settings.itemElement+'/>').addClass(this.options.itemClass).append(item);}this.trigger('prepared',{content:event.data});return event.data;};/**
	 * Updates the view.
	 * @public
	 */Owl.prototype.update=function(){var i=0,n=this._pipe.length,filter=_jquery2.default.proxy(function(p){return this[p];},this._invalidated),cache={};while(i<n){if(this._invalidated.all||_jquery2.default.grep(this._pipe[i].filter,filter).length>0){this._pipe[i].run(cache);}i++;}this._invalidated={};!this.is('valid')&&this.enter('valid');};/**
	 ...
	 * @todo #261
	 * @protected
	 */Owl.prototype.registerEventHandlers=function(){if(_jquery2.default.support.transition){this.$stage.on(_jquery2.default.support.transition.end+'.owl.core',_jquery2.default.proxy(this.onTransitionEnd,this));}if(this.settings.responsive!==false){this.on(window,'resize',this._handlers.onThrottledResize);}if(this.settings.mouseDrag){this.$element.addClass(this.options.dragClass);this.$stage.on('mousedown.owl.core',_jquery2.default.proxy(this.onDragStart,this));this.$stage.on('dragstart.owl.core selectstart.owl.core',function(){return false;});}if(this.settings.touchDrag){this.$stage.on('touchstart.owl.core',_jquery2.default.proxy(this.onDragStart,this));this.$stage.on('touchcancel.owl.core',_jquery2.default.proxy(this.onDragEnd,this));}};/**
	 * Handles `touchstart` and `mousedown` events.
	 * @todo Horizontal swipe threshold as option
	 * @todo #261
	 * @protected
	 * @param {Event} event - The event arguments.
	 */Owl.prototype.onDragStart=function(event){var stage=null;if(event.which===3){return;}if(_jquery2.default.support.transform){stage=this.$stage.css('transform').replace(/.*\(|\)| /g,'').split(',');stage={x:stage[stage.length===16?12:4],y:stage[stage.length===16?13:5]};}else{stage=this.$stage.position();stage={x:this.settings.rtl?stage.left+this.$stage.width()-this.width()+this.settings.margin:stage.left,y:stage.top};}if(this.is('animating')){_jquery2.default.support.transform?this.animate(stage.x):this.$stage.stop();this.invalidate('position');}this.$element.toggleClass(this.options.grabClass,event.type==='mousedown');this.speed(0);this._drag.time=new Date().getTime();this._drag.target=(0,_jquery2.default)(event.target);this._drag.stage.start=stage;this._drag.stage.current=stage;this._drag.pointer=this.pointer(event);(0,_jquery2.default)(document).on('mouseup.owl.core touchend.owl.core',_jquery2.default.proxy(this.onDragEnd,this));(0,_jquery2.default)(document).one('mousemove.owl.core touchmove.owl.core',_jquery2.default.proxy(function(event){var delta=this.difference(this._drag.pointer,this.pointer(event));(0,_jquery2.default)(document).on('mousemove.owl.core touchmove.owl.core',_jquery2.default.proxy(this.onDragMove,this));if(Math.abs(delta.x)<Math.abs(delta.y)&&this.is('valid')){return;}event.preventDefault();this.enter('dragging');this.trigger('drag');},this));};/**
	 ...
	 * @protected
	 * @param {Event} event - The event arguments.
	 */Owl.prototype.onDragEnd=function(event){var delta=this.difference(this._drag.pointer,this.pointer(event)),stage=this._drag.stage.current,direction=delta.x>0^this.settings.rtl?'left':'right';(0,_jquery2.default)(document).off('.owl.core');this.$element.removeClass(this.options.grabClass);if(delta.x!==0&&this.is('dragging')||!this.is('valid')){this.speed(this.settings.dragEndSpeed||this.settings.smartSpeed);this.current(this.closest(stage.x,delta.x!==0?direction:this._drag.direction));this.invalidate('position');this.update();this._drag.direction=direction;if(Math.abs(delta.x)>3||new Date().getTime()-this._drag.time>300){this._drag.target.one('click.owl.core',function(){return false;});}}if(!this.is('dragging')){return;}this.leave('dragging');this.trigger('dragged');};/**
...
_jquery2.default.each(coordinates,_jquery2.default.proxy(function(index,value){// on a left pull, check on current index
...
if(this.op(coordinate,'>',coordinates[this.minimum()])){position=coordinate=this.minimum();}else if(this.op(coordinate,'<',coordinates[this.maximum()])){position=coordinate=this.maximum();}}return position;};/**
	 ...
	 */Owl.prototype.animate=function(coordinate){var animate=this.speed()>0;this.is('animating')&&this.onTransitionEnd();if(animate){this.enter('animating');this.trigger('translate');}if(_jquery2.default.support.transform3d&&_jquery2.default.support.transition){this.$stage.css({transform:'translate3d('+coordinate+'px,0px,0px)',transition:this.speed()/1000+'s'});}else if(animate){this.$stage.animate({left:coordinate+'px'},this.speed(),this.settings.fallbackEasing,_jquery2.default.proxy(this.onTransitionEnd,this));}else{this.$stage.css({left:coordinate+'px'});}};/**
	 ...
	 */Owl.prototype.invalidate=function(part){if(_jquery2.default.type(part)==='string'){this._invalidated[part]=true;this.is('valid')&&this.leave('valid');}return _jquery2.default.map(this._invalidated,function(v,i){return i;});};/**
	 ...
	 */Owl.prototype.clones=function(position){var odd=this._clones.length/2,even=odd+this._items.length,map=function map(index){return index%2===0?even+index/2:odd-(index+1)/2;};if(position===undefined){return _jquery2.default.map(this._clones,function(v,i){return map(i);});}return _jquery2.default.map(this._clones,function(v,i){return v===position?map(i):null;});};/**
...
if((event.target||event.srcElement||event.originalTarget)!==this.$stage.get(0)){return false;}}this.leave('animating');this.trigger('translated');};/**
	 ...
	 */Owl.prototype.viewport=function(){var width;if(this.options.responsiveBaseElement!==window){width=(0,_jquery2.default)(this.options.responsiveBaseElement).width();}else if(window.innerWidth){width=window.innerWidth;}else if(document.documentElement&&document.documentElement.clientWidth){width=document.documentElement.clientWidth;}else{console.warn('Can not detect viewport width.');}return width;};/**
	 * Replaces the current content.
	 * @public
	 * @param {HTMLElement|$|String} content - The new content.
	 */Owl.prototype.replace=function(content){this.$stage.empty();this._items=[];if(content){content=content instanceof _jquery2.default?content:(0,_jquery2.default)(content);}if(this.settings.nestedItemSelector){content=content.find('.'+this.settings.nestedItemSelector);}content.filter(function(){return this.nodeType===1;}).each(_jquery2.default.proxy(function(index,item){item=this.prepare(item);this.$stage.append(item);this._items.push(item);this._mergers.push(item.find('[data-merge]').addBack('[data-merge]').attr('data-merge')*1||1);},this));this.reset(this.isNumeric(this.settings.startPosition)?this.settings.startPosition:0);this.invalidate('items');};/**
	 * Adds an item.
	 * @todo Use `item` instead of `content` for the event arguments.
	 * @public
	 * @param {HTMLElement|$|String} content - The item content to add.
	 * @param {Number} [position] - The relative position at which to insert the item otherwise the item will be added to the end.
	 */Owl.prototype.add=function(content,position){var current=this.relative(this._current);position=position===undefined?this._items.length:this.normalize(position,true);content=content instanceof _jquery2.default?content:(0,_jquery2.default)(content);this.trigger('add',{content:content,position:position});content=this.prepare(content);if(this._items.length===0||position===this._items.length){this._items.length===0&&this.$stage.append(content);this._items.length!==0&&this._items[position-1].after(content);this._items.push(content);this._mergers.push(content.find('[data-merge]').addBack('[data-merge]').attr('data-merge')*1||1);}else{this._items[position].before(content);this._items.splice(position,0,content);this._mergers.splice(position,0,content.find('[data-merge]').addBack('[data-merge]').attr('data-merge')*1||1);}this._items[current]&&this.reset(this._items[current].index());this.invalidate('items');this.trigger('added',{content:content,position:position});};/**
	 ...
	 * @protected
	 */Owl.prototype.preloadAutoWidthImages=function(images){images.each(_jquery2.default.proxy(function(i,element){this.enter('pre-loading');element=(0,_jquery2.default)(element);(0,_jquery2.default)(new Image()).one('load',_jquery2.default.proxy(function(e){element.attr('src',e.target.src);element.css('opacity',1);this.leave('pre-loading');!this.is('pre-loading')&&!this.is('initializing')&&this.refresh();},this)).attr('src',element.attr('src')||element.attr('data-src')||element.attr('data-src-retina'));},this));};/**
	 * Destroys the carousel.
	 * @public
	 */Owl.prototype.destroy=function(){this.$element.off('.owl.core');this.$stage.off('.owl.core');(0,_jquery2.default)(document).off('.owl.core');if(this.settings.responsive!==false){window.clearTimeout(this.resizeTimer);this.off(window,'resize',this._handlers.onThrottledResize);}for(var i in this._plugins){this._plugins[i].destroy();}this.$stage.children('.cloned').remove();this.$stage.unwrap();this.$stage.children().contents().unwrap();this.$stage.children().unwrap();this.$element.removeClass(this.options.refreshClass).removeClass(this.options.loadingClass).removeClass(this.options.loadedClass).removeClass(this.options.rtlClass).removeClass(this.options.dragClass).removeClass(this.options.grabClass).attr('class',this.$element.attr('class').replace(new RegExp(this.options.responsiveClass+'-\\S+\\s','g'),'')).removeData('owl.carousel');};/**
	 ...
	 */Owl.prototype.trigger=function(name,data,namespace,state,enter){var status={item:{count:this._items.length,index:this.current()}},handler=_jquery2.default.camelCase(_jquery2.default.grep(['on',name,namespace],function(v){return v;}).join('-').toLowerCase()),event=_jquery2.default.Event([name,'owl',namespace||'carousel'].join('.').toLowerCase(),_jquery2.default.extend({relatedTarget:this},status,data));if(!this._supress[name]){_jquery2.default.each(this._plugins,function(name,plugin){if(plugin.onTrigger){plugin.onTrigger(event);}});this.register({type:Owl.Type.Event,name:name});this.$element.trigger(event);if(this.settings&&typeof this.settings[handler]==='function'){this.settings[handler].call(this,event);}}return event;};/**
	 * Enters a state.
	 * @param name - The state name.
	 */Owl.prototype.enter=function(name){_jquery2.default.each([name].concat(this._states.tags[name]||[]),_jquery2.default.proxy(function(i,name){if(this._states.current[name]===undefined){this._states.current[name]=0;}this._states.current[name]++;},this));};/**
	 * Leaves a state.
	 * @param name - The state name.
	 */Owl.prototype.leave=function(name){_jquery2.default.each([name].concat(this._states.tags[name]||[]),_jquery2.default.proxy(function(i,name){this._states.current[name]--;},this));};/**
	 * Registers an event or state.
	 * @public
	 * @param {Object} object - The event or state to register.
	 */Owl.prototype.register=function(object){if(object.type===Owl.Type.Event){if(!_jquery2.default.event.special[object.name]){_jquery2.default.event.special[object.name]={};}if(!_jquery2.default.event.special[object.name].owl){var _default=_jquery2.default.event.special[object.name]._default;_jquery2.default.event.special[object.name]._default=function(e){if(_default&&_default.apply&&(!e.namespace||e.namespace.indexOf('owl')===-1)){return _default.apply(this,arguments);}return e.namespace&&e.namespace.indexOf('owl')>-1;};_jquery2.default.event.special[object.name].owl=true;}}else if(object.type===Owl.Type.State){if(!this._states.tags[object.name]){this._states.tags[object.name]=object.tags;}else{this._states.tags[object.name]=this._states.tags[object.name].concat(object.tags);}this._states.tags[object.name]=_jquery2.default.grep(this._states.tags[object.name],_jquery2.default.proxy(function(tag,i){return _jquery2.default.inArray(tag,this._states.tags[object.name])===i;},this));}};/**
	 * Suppresses events.
	 * @protected
	 * @param {Array.<String>} events - The events to suppress.
	 */Owl.prototype.suppress=function(events){_jquery2.default.each(events,_jquery2.default.proxy(function(index,event){this._supress[event]=true;},this));};/**
	 * Releases suppressed events.
	 * @protected
	 * @param {Array.<String>} events - The events to release.
	 */Owl.prototype.release=function(events){_jquery2.default.each(events,_jquery2.default.proxy(function(index,event){delete this._supress[event];},this));};/**
	 ...
	 * @public
	 */_jquery2.default.fn.owlCarousel=function(option){var args=Array.prototype.slice.call(arguments,1);return this.each(function(){var $this=(0,_jquery2.default)(this),data=$this.data('owl.carousel');if(!data){data=new Owl(this,(typeof option==='undefined'?'undefined':_typeof(option))=='object'&&option);$this.data('owl.carousel',data);_jquery2.default.each(['next','prev','to','destroy','refresh','replace','add','remove'],function(i,event){data.register({type:Owl.Type.Event,name:event});data.$element.on(event+'.owl.carousel.core',_jquery2.default.proxy(function(e){if(e.namespace&&e.relatedTarget!==this){this.suppress([event]);data[event].apply(this,[].slice.call(arguments,1));this.release([event]);}},data));});}if(typeof option=='string'&&option.charAt(0)!=='_'){data[option].apply(data,args);}});};/**
	 * The constructor for the $ Plugin
	 * @public
	 */_jquery2.default.fn.owlCarousel.Constructor=Owl;})(window,document);/**
 * AutoRefresh Plugin
 * @version 2.1.0
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */var AutoRefresh=function AutoRefresh(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'initialized.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.autoRefresh){this.watch();}},this)};// set default options
this._core.options=_jquery2.default.extend({},AutoRefresh.Defaults,this._core.options);// register event handlers
this._core.$element.on(this._handlers);};/**
	 * Default options.
	 * @public
	 */AutoRefresh.Defaults={autoRefresh:true,autoRefreshInterval:500};/**
	 * Watches the element.
	 */AutoRefresh.prototype.watch=function(){if(this._interval){return;}this._visible=this._core.$element.is(':visible');this._interval=window.setInterval(_jquery2.default.proxy(this.refresh,this),this._core.settings.autoRefreshInterval);};/**
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */var Lazy=function Lazy(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'initialized.owl.carousel change.owl.carousel resized.owl.carousel':_jquery2.default.proxy(function(e){if(!e.namespace){return;}if(!this._core.settings||!this._core.settings.lazyLoad){return;}if(e.property&&e.property.name=='position'||e.type=='initialized'){var settings=this._core.settings,n=settings.center&&Math.ceil(settings.items/2)||settings.items,i=settings.center&&n*-1||0,position=(e.property&&e.property.value!==undefined?e.property.value:this._core.current())+i,clones=this._core.clones().length,load=_jquery2.default.proxy(function(i,v){this.load(v);},this);while(i++<n){this.load(clones/2+this._core.relative(position));clones&&_jquery2.default.each(this._core.clones(this._core.relative(position)),load);position++;}}},this)};// set the default options
this._core.options=_jquery2.default.extend({},Lazy.Defaults,this._core.options);// register event handler
this._core.$element.on(this._handlers);};/**
	 * Default options.
	 * @public
	 ...
	 * @protected
	 */Lazy.prototype.load=function(position){var $item=this._core.$stage.children().eq(position),$elements=$item&&$item.find('.owl-lazy');if(!$elements||_jquery2.default.inArray($item.get(0),this._loaded)>-1){return;}$elements.each(_jquery2.default.proxy(function(index,element){var $element=(0,_jquery2.default)(element),image,url=window.devicePixelRatio>1&&$element.attr('data-src-retina')||$element.attr('data-src');this._core.trigger('load',{element:$element,url:url},'lazy');if($element.is('img')){$element.one('load.owl.lazy',_jquery2.default.proxy(function(){$element.css('opacity',1);this._core.trigger('loaded',{element:$element,url:url},'lazy');},this)).attr('src',url);}else{image=new Image();image.onload=_jquery2.default.proxy(function(){$element.css({'background-image':'url("'+url+'")','opacity':'1'});this._core.trigger('loaded',{element:$element,url:url},'lazy');},this);image.src=url;}},this));this._loaded.push($item.get(0));};/**
	 * Destroys the plugin.
	 * @public
	 */Lazy.prototype.destroy=function(){var handler,property;for(handler in this.handlers){this._core.$element.off(handler,this.handlers[handler]);}for(property in Object.getOwnPropertyNames(this)){typeof this[property]!='function'&&(this[property]=null);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.Lazy=Lazy;})(window,document);/**
 * AutoHeight Plugin
 * @version 2.1.0
 * @author Bartosz Wojciechowski
 * @author David Deutsch
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */var AutoHeight=function AutoHeight(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'initialized.owl.carousel refreshed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.autoHeight){this.update();}},this),'changed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.autoHeight&&e.property.name=='position'){this.update();}},this),'loaded.owl.lazy':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.autoHeight&&e.element.closest('.'+this._core.settings.itemClass).index()===this._core.current()){this.update();}},this)};// set default options
this._core.options=_jquery2.default.extend({},AutoHeight.Defaults,this._core.options);// register event handlers
this._core.$element.on(this._handlers);};/**
	 * Default options.
	 * @public
	 */AutoHeight.Defaults={autoHeight:false,autoHeightClass:'owl-height'};/**
	 * Updates the view.
	 */AutoHeight.prototype.update=function(){var start=this._core._current,end=start+this._core.settings.items,visible=this._core.$stage.children().toArray().slice(start,end),heights=[],maxheight=0;_jquery2.default.each(visible,function(index,item){heights.push((0,_jquery2.default)(item).height());});maxheight=Math.max.apply(null,heights);this._core.$stage.parent().height(maxheight).addClass(this._core.settings.autoHeightClass);};AutoHeight.prototype.destroy=function(){var handler,property;for(handler in this._handlers){this._core.$element.off(handler,this._handlers[handler]);}for(property in Object.getOwnPropertyNames(this)){typeof this[property]!='function'&&(this[property]=null);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.AutoHeight=AutoHeight;})(window,document);/**
 * Video Plugin
 * @version 2.1.0
 * @author Bartosz Wojciechowski
 * @author David Deutsch
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */var Video=function Video(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'initialized.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace){this._core.register({type:'state',name:'playing',tags:['interacting']});}},this),'resize.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.video&&this.isInFullScreen()){e.preventDefault();}},this),'refreshed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.is('resizing')){this._core.$stage.find('.cloned .owl-video-frame').remove();}},this),'changed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&e.property.name==='position'&&this._playing){this.stop();}},this),'prepared.owl.carousel':_jquery2.default.proxy(function(e){if(!e.namespace){return;}var $element=(0,_jquery2.default)(e.content).find('.owl-video');if($element.length){$element.css('display','none');this.fetch($element,(0,_jquery2.default)(e.content));}},this)};// set default options
this._core.options=_jquery2.default.extend({},Video.Defaults,this._core.options);// register event handlers
this._core.$element.on(this._handlers);this._core.$element.on('click.owl.video','.owl-video-play-icon',_jquery2.default.proxy(function(e){this.play(e);},this));};/**
	 * Default options.
	 * @public
...
if(customTn.length){create(customTn.attr(srcType));customTn.remove();return false;}if(video.type==='youtube'){path="//img.youtube.com/vi/"+video.id+"/hqdefault.jpg";create(path);}else if(video.type==='vimeo'){_jquery2.default.ajax({type:'GET',url:'//vimeo.com/api/v2/video/'+video.id+'.json',jsonp:'callback',dataType:'jsonp',success:function success(data){path=data[0].thumbnail_large;create(path);}});}else if(video.type==='vzaar'){_jquery2.default.ajax({type:'GET',url:'//vzaar.com/api/videos/'+video.id+'.json',jsonp:'callback',dataType:'jsonp',success:function success(data){path=data.framegrab_url;create(path);}});}};/**
	 ...
	 * @public
	 * @param {Event} event - The event arguments.
	 */Video.prototype.play=function(event){var target=(0,_jquery2.default)(event.target),item=target.closest('.'+this._core.settings.itemClass),video=this._videos[item.attr('data-video')],width=video.width||'100%',height=video.height||this._core.$stage.height(),html;if(this._playing){return;}this._core.enter('playing');this._core.trigger('play',null,'video');item=this._core.items(this._core.relative(item.index()));this._core.reset(item.index());if(video.type==='youtube'){html='<iframe width="'+width+'" height="'+height+'" src="//www.youtube.com/embed/'+video.id+'?autoplay=1&rel=0&v='+video.id+'" frameborder="0" allowfullscreen></iframe>';}else if(video.type==='vimeo'){html='<iframe src="//player.vimeo.com/video/'+video.id+'?autoplay=1" width="'+width+'" height="'+height+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';}else if(video.type==='vzaar'){html='<iframe frameborder="0"'+'height="'+height+'"'+'width="'+width+'" allowfullscreen mozallowfullscreen webkitAllowFullScreen '+'src="//view.vzaar.com/'+video.id+'/player?autoplay=true"></iframe>';}(0,_jquery2.default)('<div class="owl-video-frame">'+html+'</div>').insertAfter(item.find('.owl-video'));this._playing=item.addClass('owl-video-playing');};/**
	 * Checks whether an video is currently in full screen mode or not.
	 * @todo Bad style because looks like a readonly method but changes members.
	 * @protected
	 * @returns {Boolean}
	 */Video.prototype.isInFullScreen=function(){var element=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement;return element&&(0,_jquery2.default)(element).parent().hasClass('owl-video-frame');};/**
	 * Destroys the plugin.
	 */Video.prototype.destroy=function(){var handler,property;this._core.$element.off('click.owl.video');for(handler in this._handlers){this._core.$element.off(handler,this._handlers[handler]);}for(property in Object.getOwnPropertyNames(this)){typeof this[property]!='function'&&(this[property]=null);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.Video=Video;})(window,document);/**
 * Animate Plugin
 * @version 2.1.0
 * @author Bartosz Wojciechowski
 * @author David Deutsch
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */var Animate=function Animate(scope){this.core=scope;this.core.options=_jquery2.default.extend({},Animate.Defaults,this.core.options);this.swapping=true;this.previous=undefined;this.next=undefined;this.handlers={'change.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&e.property.name=='position'){this.previous=this.core.current();this.next=e.property.value;}},this),'drag.owl.carousel dragged.owl.carousel translated.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace){this.swapping=e.type=='translated';}},this),'translate.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this.swapping&&(this.core.options.animateOut||this.core.options.animateIn)){this.swap();}},this)};this.core.$element.on(this.handlers);};/**
	 * Default options.
	 * @public
	 ...
	 */Animate.prototype.swap=function(){if(this.core.settings.items!==1){return;}if(!_jquery2.default.support.animation||!_jquery2.default.support.transition){return;}this.core.speed(0);var left,clear=_jquery2.default.proxy(this.clear,this),previous=this.core.$stage.children().eq(this.previous),next=this.core.$stage.children().eq(this.next),incoming=this.core.settings.animateIn,outgoing=this.core.settings.animateOut;if(this.core.current()===this.previous){return;}if(outgoing){left=this.core.coordinates(this.previous)-this.core.coordinates(this.next);previous.one(_jquery2.default.support.animation.end,clear).css({'left':left+'px'}).addClass('animated owl-animated-out').addClass(outgoing);}if(incoming){next.one(_jquery2.default.support.animation.end,clear).addClass('animated owl-animated-in').addClass(incoming);}};Animate.prototype.clear=function(e){(0,_jquery2.default)(e.target).css({'left':''}).removeClass('animated owl-animated-out owl-animated-in').removeClass(this.core.settings.animateIn).removeClass(this.core.settings.animateOut);this.core.onTransitionEnd();};/**
	 * Destroys the plugin.
	 * @public
	 */Animate.prototype.destroy=function(){var handler,property;for(handler in this.handlers){this.core.$element.off(handler,this.handlers[handler]);}for(property in Object.getOwnPropertyNames(this)){typeof this[property]!='function'&&(this[property]=null);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.Animate=Animate;})(window,document);/**
 * Autoplay Plugin
 * @version 2.1.0
 * @author Bartosz Wojciechowski
 * @author Artus Kolanowski
 ...
 */;(function(window,document,undefined){/**
	 ...
	 */var Autoplay=function Autoplay(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'changed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&e.property.name==='settings'){if(this._core.settings.autoplay){this.play();}else{this.stop();}}else if(e.namespace&&e.property.name==='position'){//console.log('play?', e);
if(this._core.settings.autoplay){this._setAutoPlayInterval();}}},this),'initialized.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.autoplay){this.play();}},this),'play.owl.autoplay':_jquery2.default.proxy(function(e,t,s){if(e.namespace){this.play(t,s);}},this),'stop.owl.autoplay':_jquery2.default.proxy(function(e){if(e.namespace){this.stop();}},this),'mouseover.owl.autoplay':_jquery2.default.proxy(function(){if(this._core.settings.autoplayHoverPause&&this._core.is('rotating')){this.pause();}},this),'mouseleave.owl.autoplay':_jquery2.default.proxy(function(){if(this._core.settings.autoplayHoverPause&&this._core.is('rotating')){this.play();}},this),'touchstart.owl.core':_jquery2.default.proxy(function(){if(this._core.settings.autoplayHoverPause&&this._core.is('rotating')){this.pause();}},this),'touchend.owl.core':_jquery2.default.proxy(function(){if(this._core.settings.autoplayHoverPause){this.play();}},this)};// register event handlers
this._core.$element.on(this._handlers);// set default options
this._core.options=_jquery2.default.extend({},Autoplay.Defaults,this._core.options);};/**
	 * Default options.
	 * @public
	 ...
	 * @param {Number} [speed] - The animation speed for the animations.
	 * @return {Timeout}
	 */Autoplay.prototype._getNextTimeout=function(timeout,speed){if(this._timeout){window.clearTimeout(this._timeout);}return window.setTimeout(_jquery2.default.proxy(function(){if(this._paused||this._core.is('busy')||this._core.is('interacting')||document.hidden){return;}this._core.next(speed||this._core.settings.autoplaySpeed);},this),timeout||this._core.settings.autoplayTimeout);};/**
	 ...
	 * Destroys the plugin.
	 */Autoplay.prototype.destroy=function(){var handler,property;this.stop();for(handler in this._handlers){this._core.$element.off(handler,this._handlers[handler]);}for(property in Object.getOwnPropertyNames(this)){typeof this[property]!='function'&&(this[property]=null);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.autoplay=Autoplay;})(window,document);/**
 * Navigation Plugin
 * @version 2.1.0
 * @author Artus Kolanowski
 * @author David Deutsch
 ...
 */;(function(window,document,undefined){'use strict';/**
	 ...
	 */var Navigation=function Navigation(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'prepared.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.dotsData){this._templates.push('<div class="'+this._core.settings.dotClass+'">'+(0,_jquery2.default)(e.content).find('[data-dot]').addBack('[data-dot]').attr('data-dot')+'</div>');}},this),'added.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.dotsData){this._templates.splice(e.position,0,this._templates.pop());}},this),'remove.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.dotsData){this._templates.splice(e.position,1);}},this),'changed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&e.property.name=='position'){this.draw();}},this),'initialized.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&!this._initialized){this._core.trigger('initialize',null,'navigation');this.initialize();this.update();this.draw();this._initialized=true;this._core.trigger('initialized',null,'navigation');}},this),'refreshed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._initialized){this._core.trigger('refresh',null,'navigation');this.update();this.draw();this._core.trigger('refreshed',null,'navigation');}},this)};// set default options
this._core.options=_jquery2.default.extend({},Navigation.Defaults,this._core.options);// register event handlers
...
this._controls.$relative=(settings.navContainer?(0,_jquery2.default)(settings.navContainer):(0,_jquery2.default)('<div>').addClass(settings.navContainerClass).appendTo(this.$element)).addClass('disabled');this._controls.$previous=(0,_jquery2.default)('<'+settings.navElement+'>').addClass(settings.navClass[0]).html(settings.navText[0]).prependTo(this._controls.$relative).on('click',_jquery2.default.proxy(function(e){this.prev(settings.navSpeed);},this));this._controls.$next=(0,_jquery2.default)('<'+settings.navElement+'>').addClass(settings.navClass[1]).html(settings.navText[1]).appendTo(this._controls.$relative).on('click',_jquery2.default.proxy(function(e){this.next(settings.navSpeed);},this));// create DOM structure for absolute navigation
if(!settings.dotsData){this._templates=[(0,_jquery2.default)('<div>').addClass(settings.dotClass).append((0,_jquery2.default)('<span>')).prop('outerHTML')];}this._controls.$absolute=(settings.dotsContainer?(0,_jquery2.default)(settings.dotsContainer):(0,_jquery2.default)('<div>').addClass(settings.dotsClass).appendTo(this.$element)).addClass('disabled');this._controls.$absolute.on('click','div',_jquery2.default.proxy(function(e){var index=(0,_jquery2.default)(e.target).parent().is(this._controls.$absolute)?(0,_jquery2.default)(e.target).index():(0,_jquery2.default)(e.target).parent().index();e.preventDefault();this.to(index,settings.dotsSpeed);},this));// override public methods of the carousel
for(override in this._overrides){this._core[override]=_jquery2.default.proxy(this[override],this);}};/**
	 * Destroys the plugin.
	 * @protected
	 ...
	 * @protected
	 */Navigation.prototype.draw=function(){var difference,settings=this._core.settings,disabled=this._core.items().length<=settings.items,index=this._core.relative(this._core.current()),loop=settings.loop||settings.rewind;this._controls.$relative.toggleClass('disabled',!settings.nav||disabled);if(settings.nav){this._controls.$previous.toggleClass('disabled',!loop&&index<=this._core.minimum(true));this._controls.$next.toggleClass('disabled',!loop&&index>=this._core.maximum(true));}this._controls.$absolute.toggleClass('disabled',!settings.dots||disabled);if(settings.dots){difference=this._pages.length-this._controls.$absolute.children().length;if(settings.dotsData&&difference!==0){this._controls.$absolute.html(this._templates.join(''));}else if(difference>0){this._controls.$absolute.append(new Array(difference+1).join(this._templates[0]));}else if(difference<0){this._controls.$absolute.children().slice(difference).remove();}this._controls.$absolute.find('.active').removeClass('active');this._controls.$absolute.children().eq(_jquery2.default.inArray(this.current(),this._pages)).addClass('active');}};/**
	 * Extends event data.
	 * @protected
	 * @param {Event} event - The event object which gets thrown.
	 */Navigation.prototype.onTrigger=function(event){var settings=this._core.settings;event.page={index:_jquery2.default.inArray(this.current(),this._pages),count:this._pages.length,size:settings&&(settings.center||settings.autoWidth||settings.dotsData?1:settings.dotsEach||settings.items)};};/**
	 * Gets the current page position of the carousel.
	 * @protected
	 * @returns {Number}
	 */Navigation.prototype.current=function(){var current=this._core.relative(this._core.current());return _jquery2.default.grep(this._pages,_jquery2.default.proxy(function(page,index){return page.start<=current&&page.end>=current;},this)).pop();};/**
	 * Gets the current succesor/predecessor position.
	 * @protected
	 * @returns {Number}
	 */Navigation.prototype.getPosition=function(successor){var position,length,settings=this._core.settings;if(settings.slideBy=='page'){position=_jquery2.default.inArray(this.current(),this._pages);length=this._pages.length;successor?++position:--position;position=this._pages[(position%length+length)%length].start;}else{position=this._core.relative(this._core.current());length=this._core.items().length;successor?position+=settings.slideBy:position-=settings.slideBy;}return position;};/**
	 * Slides to the next item or page.
	 * @public
	 * @param {Number} [speed=false] - The time in milliseconds for the transition.
	 */Navigation.prototype.next=function(speed){_jquery2.default.proxy(this._overrides.to,this._core)(this.getPosition(true),speed);};/**
	 * Slides to the previous item or page.
	 * @public
	 * @param {Number} [speed=false] - The time in milliseconds for the transition.
	 */Navigation.prototype.prev=function(speed){_jquery2.default.proxy(this._overrides.to,this._core)(this.getPosition(false),speed);};/**
	 * Slides to the specified item or page.
	 * @public
	 * @param {Number} position - The position of the item or page.
	 * @param {Number} [speed] - The time in milliseconds for the transition.
	 * @param {Boolean} [standard=false] - Whether to use the standard behaviour or not.
	 */Navigation.prototype.to=function(position,speed,standard){var length;if(!standard&&this._pages.length){length=this._pages.length;_jquery2.default.proxy(this._overrides.to,this._core)(this._pages[(position%length+length)%length].start,speed);}else{_jquery2.default.proxy(this._overrides.to,this._core)(position,speed);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.Navigation=Navigation;})(window,document);/**
 * Hash Plugin
 * @version 2.1.0
 * @author Artus Kolanowski
 * @author David Deutsch
 ...
 */;(function(window,document,undefined){'use strict';/**
	 ...
	 */var Hash=function Hash(carousel){/**
		 ...
		 * @protected
		 * @type {Object}
		 */this._handlers={'initialized.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&this._core.settings.startPosition==='URLHash'){(0,_jquery2.default)(window).trigger('hashchange.owl.navigation');}},this),'prepared.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace){var hash=(0,_jquery2.default)(e.content).find('[data-hash]').addBack('[data-hash]').attr('data-hash');if(!hash){return;}this._hashes[hash]=e.content;}},this),'changed.owl.carousel':_jquery2.default.proxy(function(e){if(e.namespace&&e.property.name==='position'){var current=this._core.items(this._core.relative(this._core.current())),hash=_jquery2.default.map(this._hashes,function(item,hash){return item===current?hash:null;}).join();if(!hash||window.location.hash.slice(1)===hash){return;}window.location.hash=hash;}},this)};// set default options
this._core.options=_jquery2.default.extend({},Hash.Defaults,this._core.options);// register the event handlers
this.$element.on(this._handlers);// register event listener for hash navigation
(0,_jquery2.default)(window).on('hashchange.owl.navigation',_jquery2.default.proxy(function(e){var hash=window.location.hash.substring(1),items=this._core.$stage.children(),position=this._hashes[hash]&&items.index(this._hashes[hash]);if(position===undefined||position===this._core.current()){return;}this._core.to(this._core.relative(position),false,true);},this));};/**
	 * Default options.
	 * @public
	 */Hash.Defaults={URLhashListener:false};/**
	 * Destroys the plugin.
	 * @public
	 */Hash.prototype.destroy=function(){var handler,property;(0,_jquery2.default)(window).off('hashchange.owl.navigation');for(handler in this._handlers){this._core.$element.off(handler,this._handlers[handler]);}for(property in Object.getOwnPropertyNames(this)){typeof this[property]!='function'&&(this[property]=null);}};_jquery2.default.fn.owlCarousel.Constructor.Plugins.Hash=Hash;})(window,document);/**
 * Support Plugin
 *
 * @version 2.1.0
